...
#ifndef MCITY_TERASIM_TEST_13_realcar_HPP_
#define MCITY_TERASIM_TEST_13_realcar_HPP_
...
class Test13Realcar : public rclcpp::Node
{
public:
  explicit Test13Realcar(const rclcpp::NodeOptions & options);
  ~Test13Realcar() = default;
