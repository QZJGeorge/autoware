...
#ifndef MCITY_TERASIM_TEST_12_realcar_HPP_
#define MCITY_TERASIM_TEST_12_realcar_HPP_
...
class Test12Realcar : public rclcpp::Node
{
public:
  explicit Test12Realcar(const rclcpp::NodeOptions & options);
  ~Test12Realcar() = default;
