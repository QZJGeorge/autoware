...
#ifndef MCITY_TERASIM_TEST_08_realcar_HPP_
#define MCITY_TERASIM_TEST_08_realcar_HPP_
...
class Test08Realcar : public rclcpp::Node
{
public:
  explicit Test08Realcar(const rclcpp::NodeOptions & options);
  ~Test08Realcar() = default;
