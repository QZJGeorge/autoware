...
#ifndef MCITY_TERASIM_TEST_04_realcar_HPP_
#define MCITY_TERASIM_TEST_04_realcar_HPP_
...
class Test04Realcar : public rclcpp::Node
{
public:
  explicit Test04Realcar(const rclcpp::NodeOptions & options);
  ~Test04Realcar() = default;
