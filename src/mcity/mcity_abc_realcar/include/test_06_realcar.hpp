...
#ifndef MCITY_TERASIM_TEST_06_realcar_HPP_
#define MCITY_TERASIM_TEST_06_realcar_HPP_
...
class Test06Realcar : public rclcpp::Node
{
public:
  explicit Test06Realcar(const rclcpp::NodeOptions & options);
  ~Test06Realcar() = default;
