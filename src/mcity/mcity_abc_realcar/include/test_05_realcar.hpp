...
#ifndef MCITY_TERASIM_TEST_05_realcar_HPP_
#define MCITY_TERASIM_TEST_05_realcar_HPP_
...
class Test05Realcar : public rclcpp::Node
{
public:
  explicit Test05Realcar(const rclcpp::NodeOptions & options);
  ~Test05Realcar() = default;
