...
#ifndef MCITY_TERASIM_TEST_02_realcar_HPP_
#define MCITY_TERASIM_TEST_02_realcar_HPP_
...
class Test02Realcar : public rclcpp::Node
{
public:
  explicit Test02Realcar(const rclcpp::NodeOptions & options);
  ~Test02Realcar() = default;
