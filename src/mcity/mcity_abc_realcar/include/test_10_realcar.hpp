...
#ifndef MCITY_TERASIM_TEST_10_realcar_HPP_
#define MCITY_TERASIM_TEST_10_realcar_HPP_
...
class Test10Realcar : public rclcpp::Node
{
public:
  explicit Test10Realcar(const rclcpp::NodeOptions & options);
  ~Test10Realcar() = default;
