...
#ifndef MCITY_TERASIM_TEST_09_realcar_HPP_
#define MCITY_TERASIM_TEST_09_realcar_HPP_
...
class Test09Realcar : public rclcpp::Node
{
public:
  explicit Test09Realcar(const rclcpp::NodeOptions & options);
  ~Test09Realcar() = default;
