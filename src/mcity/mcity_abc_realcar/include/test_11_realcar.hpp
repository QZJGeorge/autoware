...
#ifndef MCITY_TERASIM_TEST_11_realcar_HPP_
#define MCITY_TERASIM_TEST_11_realcar_HPP_
...
class Test11Realcar : public rclcpp::Node
{
public:
  explicit Test11Realcar(const rclcpp::NodeOptions & options);
  ~Test11Realcar() = default;
