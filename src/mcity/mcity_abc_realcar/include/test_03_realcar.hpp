...
#ifndef MCITY_TERASIM_TEST_03_realcar_HPP_
#define MCITY_TERASIM_TEST_03_realcar_HPP_
...
class Test03Realcar : public rclcpp::Node
{
public:
  explicit Test03Realcar(const rclcpp::NodeOptions & options);
  ~Test03Realcar() = default;
