...
#include "test_03_realcar.hpp"

namespace test_03_realcar{

  Test03Realcar::Test03Realcar(const rclcpp::NodeOptions & options)
  : Node("test_03_realcar", options)
  {
    ...
    sub_autoware_state = this->create_subscription<AutowareState>(
      "/autoware/state", 10, std::bind(&Test03Realcar::autowareStateCB, this, std::placeholders::_1));
    sub_veh_state = this->create_subscription<VehicleState>(
      "/mcity/vehicle_state", 10, std::bind(&Test03Realcar::vehStateCB, this, std::placeholders::_1));
    sub_operation_mode = this->create_subscription<OperationModeState>(
      "/system/operation_mode/state", 10, std::bind(&Test03Realcar::operationModeStateCB, this, std::placeholders::_1));
    ...
    timer_ = rclcpp::create_timer(
      this, get_clock(), 100ms, std::bind(&Test03Realcar::on_timer, this));
  }

  void Test03Realcar::on_timer(){
  ...
  void Test03Realcar::pub_vehicle_report(){
  ...
  void Test03Realcar::set_route_points(){
    Pose wp0;
    ...
    wp0.orientation.z = 0.6937103340784699;
    wp0.orientation.w = 0.7203541989706096;
  ...
  void Test03Realcar::set_operation_mode(uint8_t mode){
  ...
  void Test03Realcar::autowareStateCB(const AutowareState::SharedPtr msg){
    autoware_state = msg->state;
  }

  void Test03Realcar::vehStateCB(const VehicleState::SharedPtr msg){
    veh_state_msg = *msg;
  }

  void Test03Realcar::operationModeStateCB(const OperationModeState::SharedPtr msg){
    operation_mode_state_msg = *msg;
  }
}

RCLCPP_COMPONENTS_REGISTER_NODE(test_03_realcar::Test03Realcar)
