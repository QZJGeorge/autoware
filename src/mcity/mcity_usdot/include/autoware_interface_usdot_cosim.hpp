...
class AutowareInterfaceUSDOTCosim : public rclcpp::Node
{
public:
  explicit AutowareInterfaceUSDOTCosim(const rclcpp::NodeOptions & options);
  ~AutowareInterfaceUSDOTCosim() = default;
