// Copyright 2039 Autoware Foundation
//
...
namespace test_03{
  ...
  Test03::Test03(const rclcpp::NodeOptions & options)
  : Node("test_03", options)
  {
    ...
    sub_autoware_state = this->create_subscription<AutowareState>(
      "/autoware/state", 10, std::bind(&Test03::autoware_state_callback, this, std::placeholders::_1));

    timer_ = rclcpp::create_timer(
      this, get_clock(), 1000ms, std::bind(&Test03::on_timer, this));
  ...
  void Test03::init_localization(){
    localization_msg.pose.pose.position.x = 147.34255981445312;
    localization_msg.pose.pose.position.y = 66.21968078613281;

    localization_msg.pose.pose.orientation.x = 0.0;
    localization_msg.pose.pose.orientation.y = 0.0;
    localization_msg.pose.pose.orientation.z = 0.673835751651439;
    localization_msg.pose.pose.orientation.w = 0.7388811675745567;
  ...
  void Test03::set_route_points(){
    goal_msg.pose.position.x = 160.74681091308594;
    goal_msg.pose.position.y = 325.388427734375;

    goal_msg.pose.orientation.x = 0.0;
    goal_msg.pose.orientation.y = 0.0;
    goal_msg.pose.orientation.z = 0.3990938259811239;
    goal_msg.pose.orientation.w = 0.9169100926828914;
  ...
  void Test03::set_operation_mode(uint8_t mode){
  ...
  void Test03::set_autoware_control(bool autoware_control){
  ...
  void Test03::autoware_state_callback(AutowareState::SharedPtr msg){
    autoware_state = msg->state;
  }
}

RCLCPP_COMPONENTS_REGISTER_NODE(test_03::Test03)
