...
namespace test_14{
  ...
  Test14::Test14(const rclcpp::NodeOptions & options)
  : Node("test_14", options)
  {
    ...
    sub_autoware_state = this->create_subscription<AutowareState>(
      "/autoware/state", 10, std::bind(&Test14::autoware_state_callback, this, std::placeholders::_1));

    timer_ = rclcpp::create_timer(
      this, get_clock(), 1000ms, std::bind(&Test14::on_timer, this));

    init_redis_client();
  }

  void Test14::on_timer(){
  ...
  void Test14::publish_localization(){
  ...
  void Test14::publish_goal(){
    goal_msg.pose.position.x = 77658.4921875;
    goal_msg.pose.position.y = 86823.328125;

    goal_msg.pose.orientation.x = 0.0;
    goal_msg.pose.orientation.y = 0.0;
    goal_msg.pose.orientation.z = 0.6902300376905816;
    goal_msg.pose.orientation.w = 0.7235900048160273;
  ...
  void Test14::set_operation_mode(uint8_t mode){
  ...
  void Test14::set_autoware_control(bool autoware_control){
  ...
  void Test14::autoware_state_callback(AutowareState::SharedPtr msg){
    autoware_state = msg->state;
  }

  void Test14::init_redis_client(){
  ...
  string Test14::get_key(string key){
    // GET key
...
RCLCPP_COMPONENTS_REGISTER_NODE(test_14::Test14)
