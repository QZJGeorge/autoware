...
namespace test_13{
  ...
  Test13::Test13(const rclcpp::NodeOptions & options)
  : Node("test_13", options)
  {
    ...
    sub_autoware_state = this->create_subscription<AutowareState>(
      "/autoware/state", 10, std::bind(&Test13::autoware_state_callback, this, std::placeholders::_1));
  ...
  void Test13::set_operation_mode(uint8_t mode){
  ...
  void Test13::set_autoware_control(bool autoware_control){
...
RCLCPP_COMPONENTS_REGISTER_NODE(test_13::Test13)
