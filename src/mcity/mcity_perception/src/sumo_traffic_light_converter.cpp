...
#include <sumo_traffic_light_converter.hpp>

namespace sumo_traffic_light_converter{

  SumoTrafficLightConverter::SumoTrafficLightConverter(const rclcpp::NodeOptions & options)
  : Node("sumo_traffic_light_converter", options)
  {
...
RCLCPP_COMPONENTS_REGISTER_NODE(sumo_traffic_light_converter::SumoTrafficLightConverter)
