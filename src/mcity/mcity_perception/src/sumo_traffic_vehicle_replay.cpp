...
#include <sumo_traffic_vehicle_replay.hpp>
...
namespace sumo_traffic_vehicle_replay
{
  ...
  void SumoTrafficVehicleReplay::read_file(){
...
RCLCPP_COMPONENTS_REGISTER_NODE(sumo_traffic_vehicle_replay::SumoTrafficVehicleReplay)
