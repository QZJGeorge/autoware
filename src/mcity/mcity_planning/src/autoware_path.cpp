...
namespace autoware_path{
    ...
    : Node("autoware_path", options){
        ...
        sub_trajectory = this->create_subscription<Trajectory>(
            "/planning/scenario_planning/trajectory", 10, std::bind(&AutowarePath::trajectory_callback, this, std::placeholders::_1));
    ...
    void AutowarePath::on_traj_timer(){
    ...
    void AutowarePath::trajectory_callback(const Trajectory::SharedPtr msg){
...
RCLCPP_COMPONENTS_REGISTER_NODE(autoware_path::AutowarePath)