...
#ifndef MCITY_TERASIM__autoware_interface_voices_realcar_HPP_
#define MCITY_TERASIM__autoware_interface_voices_realcar_HPP_
...
class AutowareInterfaceVoicesRealcar : public rclcpp::Node
{
public:
  explicit AutowareInterfaceVoicesRealcar(const rclcpp::NodeOptions & options);
