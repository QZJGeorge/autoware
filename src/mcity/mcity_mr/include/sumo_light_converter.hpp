...
#ifndef mcity_mr_sumo_light_converter_HPP_
#define mcity_mr_sumo_light_converter_HPP_
...
class SumoLightConverter : public rclcpp::Node
{
public:
  explicit SumoLightConverter(const rclcpp::NodeOptions & options);
  ~SumoLightConverter() = default;
