#ifndef mcity_vi_AUTOWARE_INTERFACE_vi_realcar_HPP_
#define mcity_vi_AUTOWARE_INTERFACE_vi_realcar_HPP_
...
class AutowareInterfaceVIRealcar : public rclcpp::Node
{
public:
  explicit AutowareInterfaceVIRealcar(const rclcpp::NodeOptions & options);
  ~AutowareInterfaceVIRealcar() = default;
