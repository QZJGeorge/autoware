...
#ifndef MCITY_COSIM_autoware_interface_voices_HPP_
#define MCITY_COSIM_autoware_interface_voices_HPP_
...
class AutowareInterfaceVoices : public rclcpp::Node
{
public:
  explicit AutowareInterfaceVoices(const rclcpp::NodeOptions & options);
  ~AutowareInterfaceVoices() = default;
