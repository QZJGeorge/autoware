...
namespace autoware_interface{
  ...
  : Node("autoware_interface", options)
  {
    ...
    sub_autoware_state = this->create_subscription<AutowareState>(
      "/autoware/state", 10, std::bind(&AutowareInterface::autoware_state_callback, this, std::placeholders::_1));
    ...
    timer_ = rclcpp::create_timer(
      this, get_clock(), 1000ms, std::bind(&AutowareInterface::on_timer, this));
  ...
  void AutowareInterface::init_localization(){
  ...
  void AutowareInterface::pub_localization(){
  ...
  void AutowareInterface::set_autoware_control(bool autoware_control){
  ...
  void AutowareInterface::autoware_state_callback(AutowareState::SharedPtr msg){
    autoware_state = msg->state;
  }

  void AutowareInterface::init_redis_client(){
  ...
  string AutowareInterface::get_key(string key){
    // GET key
