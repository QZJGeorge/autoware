...
/*    static inline void UTM(double lat, double lon, double *x, double *y)
    {
        float earth_r   = 6371004.0f;
        float longitude = -1.460877f;
        float latitude  = 0.73824f;
        
        *x = (lon*M_PI/180 - longitude ) * earth_r * cos(lat*M_PI/180);
        *y = (lat*M_PI/180 - latitude  ) * earth_r;
