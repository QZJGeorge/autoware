...
public:
    ...
    void cal(float x, float &y, float & y_d, float & y_dd, long & Ntg);
...
void spline::cal(float x, float &y, float & y_d, float & y_dd, long & Ntg)
{
    size_t n=m_x.size();
    ...
    else 
    {
        ...
        y_d=(3*m_a[idx]*h + 2*m_b[idx])*h + m_c[idx];
        y_dd=6*m_a[idx]*h + 2*m_b[idx];
    }
