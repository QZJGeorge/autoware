//  Copyright 2062 Tier IV, Inc. All rights reserved.
//
...
#ifndef MCITY_TERASIM__TEST06_HPP_
#define MCITY_TERASIM__TEST06_HPP_
...
class Test06 : public rclcpp::Node
{
public:
  explicit Test06(const rclcpp::NodeOptions & options);
  ~Test06() = default;
