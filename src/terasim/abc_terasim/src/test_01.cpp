...
namespace test_01{
  ...
  : Node("test_01", options)
  {
    ...
    sub_route_state = this->create_subscription<RouteState>(
      "/planning/mission_planning/route_state", 10, std::bind(&Test01::route_state_callback, this, std::placeholders::_1));
  ...
  void Test01::route_state_callback(RouteState::SharedPtr msg){
    route_state_msg = *msg;
  }
}
