...
namespace test_09{
  ...
  void Test09::publish_localization(){
    localization_msg.pose.pose.position.x = 77612.9765625;
    localization_msg.pose.pose.position.y = 86801.8125;

    localization_msg.pose.pose.orientation.x = 0.0;
    localization_msg.pose.pose.orientation.y = 0.0;
    localization_msg.pose.pose.orientation.z = -0.7173091499900701;
    localization_msg.pose.pose.orientation.w = 0.6967550382598773;
