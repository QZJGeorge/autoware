...
#ifndef SUMO_TERASIM__CREATE_OCCUPANCY_GRID__HPP_
#define SUMO_TERASIM__CREATE_OCCUPANCY_GRID_HPP_
...
class CreateOccupancyGrid : public rclcpp::Node
{
public:
  explicit CreateOccupancyGrid(const rclcpp::NodeOptions & options);
  ~CreateOccupancyGrid() = default;
