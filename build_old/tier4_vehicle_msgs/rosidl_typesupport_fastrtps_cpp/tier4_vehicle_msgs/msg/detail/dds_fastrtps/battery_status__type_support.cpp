...
#include "tier4_vehicle_msgs/msg/detail/battery_status__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const tier4_vehicle_msgs::msg::BatteryStatus & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  tier4_vehicle_msgs::msg::BatteryStatus & ros_message)
{
  // Member: stamp
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = tier4_vehicle_msgs::msg::BatteryStatus;
    is_plain =
      (
      offsetof(DataType, energy_level) +
      last_member_size
      ) == ret_val;
  }
...
{
  auto typed_message =
    static_cast<const tier4_vehicle_msgs::msg::BatteryStatus *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<tier4_vehicle_msgs::msg::BatteryStatus *>(
    untyped_ros_message);
...
get_message_type_support_handle<tier4_vehicle_msgs::msg::BatteryStatus>()
{
  return &tier4_vehicle_msgs::msg::typesupport_fastrtps_cpp::_BatteryStatus__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, tier4_vehicle_msgs, msg, BatteryStatus)() {
  return &tier4_vehicle_msgs::msg::typesupport_fastrtps_cpp::_BatteryStatus__handle;
}
