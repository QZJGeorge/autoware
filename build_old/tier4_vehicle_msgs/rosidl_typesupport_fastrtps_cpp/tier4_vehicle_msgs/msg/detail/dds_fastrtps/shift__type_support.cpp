  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = tier4_vehicle_msgs::msg::Shift;
    is_plain =
      (
...
static size_t _Shift__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_Shift(full_bounded, is_plain, 0);
