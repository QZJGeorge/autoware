  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = tier4_system_msgs__srv__ChangeAutowareControl_Request;
    is_plain =
      (
      offsetof(DataType, autoware_control) +
      last_member_size
      ) == ret_val;
  }
...
static size_t _ChangeAutowareControl_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_tier4_system_msgs__srv__ChangeAutowareControl_Request(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = tier4_system_msgs__srv__ChangeAutowareControl_Response;
    is_plain =
      (
...
static size_t _ChangeAutowareControl_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_tier4_system_msgs__srv__ChangeAutowareControl_Response(
    full_bounded, is_plain, 0);
