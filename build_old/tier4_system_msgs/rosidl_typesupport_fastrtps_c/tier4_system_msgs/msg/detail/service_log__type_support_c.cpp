  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = tier4_system_msgs__msg__ServiceLog;
    is_plain =
      (
      offsetof(DataType, yaml) +
      last_member_size
      ) == ret_val;
  }
...
static size_t _ServiceLog__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_tier4_system_msgs__msg__ServiceLog(
