...
void fetch_function__DiagnosticGraph__nodes(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const auto & item = *reinterpret_cast<const tier4_system_msgs::msg::DiagnosticNode *>(
    get_const_function__DiagnosticGraph__nodes(untyped_member, index));
  auto & value = *reinterpret_cast<tier4_system_msgs::msg::DiagnosticNode *>(untyped_value);
  value = item;
}

void assign_function__DiagnosticGraph__nodes(
  void * untyped_member, size_t index, const void * untyped_value)
{
  auto & item = *reinterpret_cast<tier4_system_msgs::msg::DiagnosticNode *>(
    get_function__DiagnosticGraph__nodes(untyped_member, index));
  const auto & value = *reinterpret_cast<const tier4_system_msgs::msg::DiagnosticNode *>(untyped_value);
  item = value;
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember DiagnosticGraph_message_member_array[2] = {
  ...
  },
  {
    ...
    fetch_function__DiagnosticGraph__nodes,  // fetch(index, &value) function pointer
    assign_function__DiagnosticGraph__nodes,  // assign(index, value) function pointer
