...
#define NODE_MAIN_LOGGER_NAME "autoware_interface_voices_realcar"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libautoware_interface_voices_realcar_component.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<autoware_interface_voices_realcar::AutowareInterfaceVoicesRealcar>";
