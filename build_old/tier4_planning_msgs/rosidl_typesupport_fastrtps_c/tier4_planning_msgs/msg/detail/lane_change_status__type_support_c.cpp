...
#include "tier4_planning_msgs/msg/detail/lane_change_status__rosidl_typesupport_fastrtps_c.h"
...
using _LaneChangeStatus__ros_msg_type = tier4_planning_msgs__msg__LaneChangeStatus;
...
size_t get_serialized_size_tier4_planning_msgs__msg__LaneChangeStatus(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _LaneChangeStatus__ros_msg_type * ros_message = static_cast<const _LaneChangeStatus__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _LaneChangeStatus__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_tier4_planning_msgs__msg__LaneChangeStatus(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_tier4_planning_msgs
size_t max_serialized_size_tier4_planning_msgs__msg__LaneChangeStatus(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = tier4_planning_msgs__msg__LaneChangeStatus;
    is_plain =
      (
...
static size_t _LaneChangeStatus__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_tier4_planning_msgs__msg__LaneChangeStatus(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, tier4_planning_msgs, msg, LaneChangeStatus)() {
