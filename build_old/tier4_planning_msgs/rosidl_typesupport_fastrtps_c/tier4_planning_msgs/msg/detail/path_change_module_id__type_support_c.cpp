...
#include "tier4_planning_msgs/msg/detail/path_change_module_id__rosidl_typesupport_fastrtps_c.h"
...
using _PathChangeModuleId__ros_msg_type = tier4_planning_msgs__msg__PathChangeModuleId;
...
static uint32_t _PathChangeModuleId__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_tier4_planning_msgs__msg__PathChangeModuleId(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = tier4_planning_msgs__msg__PathChangeModuleId;
    is_plain =
      (
...
static size_t _PathChangeModuleId__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_tier4_planning_msgs__msg__PathChangeModuleId(
