...
#include "tier4_planning_msgs/msg/detail/path__rosidl_typesupport_fastrtps_c.h"
...
#include "tier4_planning_msgs/msg/detail/path_point__functions.h"  // points
...
using _Path__ros_msg_type = tier4_planning_msgs__msg__Path;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: points
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
        rosidl_typesupport_fastrtps_c, tier4_planning_msgs, msg, PathPoint
      )()->data);
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: points
  {
    ...
    if (ros_message->points.data) {
      tier4_planning_msgs__msg__PathPoint__Sequence__fini(&ros_message->points);
    }
    if (!tier4_planning_msgs__msg__PathPoint__Sequence__init(&ros_message->points, size)) {
  ...
  size_t current_alignment)
{
  ...
  // field.name points
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += get_serialized_size_tier4_planning_msgs__msg__PathPoint(
...
static uint32_t _Path__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_tier4_planning_msgs__msg__Path(
  ...
  size_t current_alignment)
{
  ...
  // member: points
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      size_t inner_size;
      inner_size =
        max_serialized_size_tier4_planning_msgs__msg__PathPoint(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = tier4_planning_msgs__msg__Path;
    is_plain =
      (
...
static size_t _Path__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_tier4_planning_msgs__msg__Path(
