...
#include "tier4_planning_msgs/msg/detail/trajectory_point__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const tier4_planning_msgs::msg::TrajectoryPoint & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  tier4_planning_msgs::msg::TrajectoryPoint & ros_message)
{
  // Member: pose
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = tier4_planning_msgs::msg::TrajectoryPoint;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const tier4_planning_msgs::msg::TrajectoryPoint *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<tier4_planning_msgs::msg::TrajectoryPoint *>(
    untyped_ros_message);
...
get_message_type_support_handle<tier4_planning_msgs::msg::TrajectoryPoint>()
{
  return &tier4_planning_msgs::msg::typesupport_fastrtps_cpp::_TrajectoryPoint__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, tier4_planning_msgs, msg, TrajectoryPoint)() {
  return &tier4_planning_msgs::msg::typesupport_fastrtps_cpp::_TrajectoryPoint__handle;
}
