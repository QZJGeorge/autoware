...
#include "tier4_planning_msgs/msg/detail/lane_change_status__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const tier4_planning_msgs::msg::LaneChangeStatus & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  tier4_planning_msgs::msg::LaneChangeStatus & ros_message)
{
  // Member: stamp
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = tier4_planning_msgs::msg::LaneChangeStatus;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const tier4_planning_msgs::msg::LaneChangeStatus *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<tier4_planning_msgs::msg::LaneChangeStatus *>(
    untyped_ros_message);
...
{
  return &tier4_planning_msgs::msg::typesupport_fastrtps_cpp::_LaneChangeStatus__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, tier4_planning_msgs, msg, LaneChangeStatus)() {
  return &tier4_planning_msgs::msg::typesupport_fastrtps_cpp::_LaneChangeStatus__handle;
}
