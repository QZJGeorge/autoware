...
#include "tier4_planning_msgs/msg/detail/avoidance_debug_msg_array__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const tier4_planning_msgs::msg::AvoidanceDebugMsg &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  ...
  tier4_planning_msgs::msg::AvoidanceDebugMsgArray & ros_message)
{
  ...
  // Member: avoidance_info
  {
    ...
    ros_message.avoidance_info.resize(size);
    for (size_t i = 0; i < size; i++) {
      tier4_planning_msgs::msg::typesupport_fastrtps_cpp::cdr_deserialize(
        cdr, ros_message.avoidance_info[i]);
    }
  }
  ...
  // Member: avoidance_info
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        ...
        ros_message.avoidance_info[index], current_alignment);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Member: avoidance_info
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        tier4_planning_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_AvoidanceDebugMsg(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = tier4_planning_msgs::msg::AvoidanceDebugMsgArray;
    is_plain =
      (
      offsetof(DataType, avoidance_info) +
      last_member_size
      ) == ret_val;
  }
...
{
  auto typed_message =
    static_cast<const tier4_planning_msgs::msg::AvoidanceDebugMsgArray *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<tier4_planning_msgs::msg::AvoidanceDebugMsgArray *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _AvoidanceDebugMsgArray__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const tier4_planning_msgs::msg::AvoidanceDebugMsgArray *>(
...
static size_t _AvoidanceDebugMsgArray__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_AvoidanceDebugMsgArray(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _AvoidanceDebugMsgArray__callbacks = {
...
static rosidl_message_type_support_t _AvoidanceDebugMsgArray__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_AvoidanceDebugMsgArray__callbacks,
...
{
  return &tier4_planning_msgs::msg::typesupport_fastrtps_cpp::_AvoidanceDebugMsgArray__handle;
}
