...
#define NODE_MAIN_LOGGER_NAME "simple_object_merger_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libsimple_object_merger_node_component.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<simple_object_merger::SimpleObjectMergerNode>";
