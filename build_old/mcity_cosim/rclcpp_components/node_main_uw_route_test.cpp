...
#define NODE_MAIN_LOGGER_NAME "uw_route_test"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libuw_route_test_component.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<uw_route_test::UwRouteTest>";
