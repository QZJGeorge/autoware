...
#include "tier4_external_api_msgs/msg/detail/service__rosidl_typesupport_fastrtps_c.h"
...
using _Service__ros_msg_type = tier4_external_api_msgs__msg__Service;
  ...
  void * untyped_ros_message)
{
  ...
  _Service__ros_msg_type * ros_message = static_cast<_Service__ros_msg_type *>(untyped_ros_message);
  // Field name: mode
  {
    cdr >> ros_message->mode;
  }
...
static uint32_t _Service__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_tier4_external_api_msgs__msg__Service(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = tier4_external_api_msgs__msg__Service;
    is_plain =
      (
...
static size_t _Service__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_tier4_external_api_msgs__msg__Service(
