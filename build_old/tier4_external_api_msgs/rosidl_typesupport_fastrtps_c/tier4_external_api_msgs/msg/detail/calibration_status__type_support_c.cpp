...
#include "tier4_external_api_msgs/msg/detail/calibration_status__rosidl_typesupport_fastrtps_c.h"
...
#include "tier4_external_api_msgs/msg/detail/calibration_status__struct.h"
...
using _CalibrationStatus__ros_msg_type = tier4_external_api_msgs__msg__CalibrationStatus;
...
static uint32_t _CalibrationStatus__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_tier4_external_api_msgs__msg__CalibrationStatus(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = tier4_external_api_msgs__msg__CalibrationStatus;
    is_plain =
      (
...
static size_t _CalibrationStatus__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_tier4_external_api_msgs__msg__CalibrationStatus(
