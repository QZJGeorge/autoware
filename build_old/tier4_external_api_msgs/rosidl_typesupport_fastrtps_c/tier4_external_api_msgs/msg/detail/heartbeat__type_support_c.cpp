...
#include "tier4_external_api_msgs/msg/detail/heartbeat__rosidl_typesupport_fastrtps_c.h"
...
#include "tier4_external_api_msgs/msg/detail/heartbeat__struct.h"
...
using _Heartbeat__ros_msg_type = tier4_external_api_msgs__msg__Heartbeat;
...
size_t get_serialized_size_tier4_external_api_msgs__msg__Heartbeat(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Heartbeat__ros_msg_type * ros_message = static_cast<const _Heartbeat__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _Heartbeat__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_tier4_external_api_msgs__msg__Heartbeat(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_tier4_external_api_msgs
size_t max_serialized_size_tier4_external_api_msgs__msg__Heartbeat(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = tier4_external_api_msgs__msg__Heartbeat;
    is_plain =
      (
...
static size_t _Heartbeat__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_tier4_external_api_msgs__msg__Heartbeat(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, tier4_external_api_msgs, msg, Heartbeat)() {
