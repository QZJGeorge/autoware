...
#include "tier4_external_api_msgs/msg/detail/steering__rosidl_typesupport_fastrtps_c.h"
...
using _Steering__ros_msg_type = tier4_external_api_msgs__msg__Steering;
...
static uint32_t _Steering__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_tier4_external_api_msgs__msg__Steering(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = tier4_external_api_msgs__msg__Steering;
    is_plain =
      (
...
static size_t _Steering__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_tier4_external_api_msgs__msg__Steering(
