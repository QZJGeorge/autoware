...
#include "tier4_external_api_msgs/srv/detail/set_pose__rosidl_typesupport_fastrtps_c.h"
...
#include "tier4_external_api_msgs/srv/detail/set_pose__struct.h"
#include "tier4_external_api_msgs/srv/detail/set_pose__functions.h"
...
using _SetPose_Request__ros_msg_type = tier4_external_api_msgs__srv__SetPose_Request;
...
size_t get_serialized_size_tier4_external_api_msgs__srv__SetPose_Request(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _SetPose_Request__ros_msg_type * ros_message = static_cast<const _SetPose_Request__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _SetPose_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_tier4_external_api_msgs__srv__SetPose_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_tier4_external_api_msgs
size_t max_serialized_size_tier4_external_api_msgs__srv__SetPose_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = tier4_external_api_msgs__srv__SetPose_Request;
    is_plain =
      (
...
static size_t _SetPose_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_tier4_external_api_msgs__srv__SetPose_Request(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, tier4_external_api_msgs, srv, SetPose_Request)() {
...
using _SetPose_Response__ros_msg_type = tier4_external_api_msgs__srv__SetPose_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_tier4_external_api_msgs
size_t get_serialized_size_tier4_external_api_msgs__srv__SetPose_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _SetPose_Response__ros_msg_type * ros_message = static_cast<const _SetPose_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_tier4_external_api_msgs__srv__SetPose_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_tier4_external_api_msgs
size_t max_serialized_size_tier4_external_api_msgs__srv__SetPose_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = tier4_external_api_msgs__srv__SetPose_Response;
    is_plain =
      (
...
static size_t _SetPose_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_tier4_external_api_msgs__srv__SetPose_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, tier4_external_api_msgs, srv, SetPose_Response)() {
...
// already included above
// #include "tier4_external_api_msgs/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "tier4_external_api_msgs/srv/set_pose.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, tier4_external_api_msgs, srv, SetPose)() {
