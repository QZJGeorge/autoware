...
#include "tier4_external_api_msgs/msg/detail/gear_shift_stamped__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const tier4_external_api_msgs::msg::GearShiftStamped & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  tier4_external_api_msgs::msg::GearShiftStamped & ros_message)
{
  // Member: stamp
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_tier4_external_api_msgs
max_serialized_size_GearShiftStamped(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = tier4_external_api_msgs::msg::GearShiftStamped;
    is_plain =
      (
      offsetof(DataType, gear_shift) +
      last_member_size
      ) == ret_val;
  }
...
{
  auto typed_message =
    static_cast<const tier4_external_api_msgs::msg::GearShiftStamped *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<tier4_external_api_msgs::msg::GearShiftStamped *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _GearShiftStamped__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const tier4_external_api_msgs::msg::GearShiftStamped *>(
...
static size_t _GearShiftStamped__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_GearShiftStamped(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _GearShiftStamped__callbacks = {
...
static rosidl_message_type_support_t _GearShiftStamped__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_GearShiftStamped__callbacks,
...
{
  return &tier4_external_api_msgs::msg::typesupport_fastrtps_cpp::_GearShiftStamped__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, tier4_external_api_msgs, msg, GearShiftStamped)() {
  return &tier4_external_api_msgs::msg::typesupport_fastrtps_cpp::_GearShiftStamped__handle;
}
