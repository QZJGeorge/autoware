...
#include "tier4_external_api_msgs/msg/detail/vehicle_command__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const tier4_external_api_msgs::msg::VehicleCommand & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  tier4_external_api_msgs::msg::VehicleCommand & ros_message)
{
  // Member: velocity
  cdr >> ros_message.velocity;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = tier4_external_api_msgs::msg::VehicleCommand;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const tier4_external_api_msgs::msg::VehicleCommand *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<tier4_external_api_msgs::msg::VehicleCommand *>(
    untyped_ros_message);
...
get_message_type_support_handle<tier4_external_api_msgs::msg::VehicleCommand>()
{
  return &tier4_external_api_msgs::msg::typesupport_fastrtps_cpp::_VehicleCommand__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, tier4_external_api_msgs, msg, VehicleCommand)() {
  return &tier4_external_api_msgs::msg::typesupport_fastrtps_cpp::_VehicleCommand__handle;
}
