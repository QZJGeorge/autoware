...
#include "tier4_external_api_msgs/msg/detail/route__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const tier4_external_api_msgs::msg::RouteSection &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
...
cdr_serialize(
  const tier4_external_api_msgs::msg::Route & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  tier4_external_api_msgs::msg::Route & ros_message)
{
  // Member: goal_pose
  ...
  // Member: route_sections
  {
    ...
    ros_message.route_sections.resize(size);
    for (size_t i = 0; i < size; i++) {
      tier4_external_api_msgs::msg::typesupport_fastrtps_cpp::cdr_deserialize(
        cdr, ros_message.route_sections[i]);
    }
  }
  ...
  // Member: route_sections
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        ...
        ros_message.route_sections[index], current_alignment);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Member: route_sections
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        tier4_external_api_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_RouteSection(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = tier4_external_api_msgs::msg::Route;
    is_plain =
      (
      offsetof(DataType, route_sections) +
      last_member_size
      ) == ret_val;
  }
...
{
  auto typed_message =
    static_cast<const tier4_external_api_msgs::msg::Route *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<tier4_external_api_msgs::msg::Route *>(
    untyped_ros_message);
...
{
  return &tier4_external_api_msgs::msg::typesupport_fastrtps_cpp::_Route__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, tier4_external_api_msgs, msg, Route)() {
  return &tier4_external_api_msgs::msg::typesupport_fastrtps_cpp::_Route__handle;
}
