...
#include "tier4_external_api_msgs/srv/detail/set_route__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const tier4_external_api_msgs::msg::Route &,
...
cdr_serialize(
  const tier4_external_api_msgs::srv::SetRoute_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  tier4_external_api_msgs::srv::SetRoute_Request & ros_message)
{
  // Member: route
  ...
  size_t current_alignment)
{
  ...
  // Member: route
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        tier4_external_api_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_Route(
  ...
  if (is_plain) {
    ...
    using DataType = tier4_external_api_msgs::srv::SetRoute_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const tier4_external_api_msgs::srv::SetRoute_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<tier4_external_api_msgs::srv::SetRoute_Request *>(
    untyped_ros_message);
...
get_message_type_support_handle<tier4_external_api_msgs::srv::SetRoute_Request>()
{
  return &tier4_external_api_msgs::srv::typesupport_fastrtps_cpp::_SetRoute_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, tier4_external_api_msgs, srv, SetRoute_Request)() {
  return &tier4_external_api_msgs::srv::typesupport_fastrtps_cpp::_SetRoute_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_tier4_external_api_msgs
cdr_serialize(
  const tier4_external_api_msgs::srv::SetRoute_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: status
  tier4_external_api_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  tier4_external_api_msgs::srv::SetRoute_Response & ros_message)
{
  // Member: status
  tier4_external_api_msgs::msg::typesupport_fastrtps_cpp::cdr_deserialize(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = tier4_external_api_msgs::srv::SetRoute_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const tier4_external_api_msgs::srv::SetRoute_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<tier4_external_api_msgs::srv::SetRoute_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_tier4_external_api_msgs
const rosidl_message_type_support_t *
get_message_type_support_handle<tier4_external_api_msgs::srv::SetRoute_Response>()
{
  return &tier4_external_api_msgs::srv::typesupport_fastrtps_cpp::_SetRoute_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, tier4_external_api_msgs, srv, SetRoute_Response)() {
  return &tier4_external_api_msgs::srv::typesupport_fastrtps_cpp::_SetRoute_Response__handle;
}
...
get_service_type_support_handle<tier4_external_api_msgs::srv::SetRoute>()
{
  return &tier4_external_api_msgs::srv::typesupport_fastrtps_cpp::_SetRoute__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, tier4_external_api_msgs, srv, SetRoute)() {
  return &tier4_external_api_msgs::srv::typesupport_fastrtps_cpp::_SetRoute__handle;
}
