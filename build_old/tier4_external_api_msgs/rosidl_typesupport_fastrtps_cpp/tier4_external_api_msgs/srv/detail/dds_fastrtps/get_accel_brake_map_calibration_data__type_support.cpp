  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = tier4_external_api_msgs::srv::GetAccelBrakeMapCalibrationData_Request;
    is_plain =
      (
...
static size_t _GetAccelBrakeMapCalibrationData_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_GetAccelBrakeMapCalibrationData_Request(full_bounded, is_plain, 0);
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = tier4_external_api_msgs::srv::GetAccelBrakeMapCalibrationData_Response;
    is_plain =
      (
...
static size_t _GetAccelBrakeMapCalibrationData_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_GetAccelBrakeMapCalibrationData_Response(full_bounded, is_plain, 0);
