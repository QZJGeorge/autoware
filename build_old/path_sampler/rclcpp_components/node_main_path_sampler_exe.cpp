...
#define NODE_MAIN_LOGGER_NAME "path_sampler_exe"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libpath_sampler.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<path_sampler::PathSampler>";
