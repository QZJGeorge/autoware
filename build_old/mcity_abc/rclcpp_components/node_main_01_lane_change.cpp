...
#define NODE_MAIN_LOGGER_NAME "01_lane_change"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libtest_01_component.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<test_01::Test01>";
