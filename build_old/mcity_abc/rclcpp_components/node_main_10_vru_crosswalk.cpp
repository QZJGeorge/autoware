...
#define NODE_MAIN_LOGGER_NAME "10_vru_crosswalk"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libtest_10_component.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<test_10::Test10>";
