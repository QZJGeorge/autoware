...
#define NODE_MAIN_LOGGER_NAME "13_vehicle_encroachment"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libtest_13_component.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<test_13::Test13>";
