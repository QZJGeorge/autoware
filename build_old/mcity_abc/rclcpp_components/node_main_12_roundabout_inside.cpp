...
#define NODE_MAIN_LOGGER_NAME "12_roundabout_inside"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libtest_12_component.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<test_12::Test12>";
