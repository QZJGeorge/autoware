...
#define NODE_MAIN_LOGGER_NAME "06_left_turn_turn"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libtest_06_component.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<test_06::Test06>";
