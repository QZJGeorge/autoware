...
#define NODE_MAIN_LOGGER_NAME "02_car_following"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libtest_02_component.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<test_02::Test02>";
