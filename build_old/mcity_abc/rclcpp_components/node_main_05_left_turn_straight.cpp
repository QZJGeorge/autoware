...
#define NODE_MAIN_LOGGER_NAME "05_left_turn_straight"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libtest_05_component.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<test_05::Test05>";
