...
#define NODE_MAIN_LOGGER_NAME "09_jaywalking"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libtest_09_component.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<test_09::Test09>";
