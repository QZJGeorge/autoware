...
#define NODE_MAIN_LOGGER_NAME "08_right_turn_turn"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libtest_08_component.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<test_08::Test08>";
