...
#define NODE_MAIN_LOGGER_NAME "04_lane_departure_opposite"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libtest_04_component.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<test_04::Test04>";
