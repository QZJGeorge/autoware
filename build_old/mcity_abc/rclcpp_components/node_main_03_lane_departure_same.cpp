...
#define NODE_MAIN_LOGGER_NAME "03_lane_departure_same"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libtest_03_component.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<test_03::Test03>";
