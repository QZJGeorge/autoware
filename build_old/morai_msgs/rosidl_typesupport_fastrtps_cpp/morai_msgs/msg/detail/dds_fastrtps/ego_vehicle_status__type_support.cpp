...
#include "morai_msgs/msg/detail/ego_vehicle_status__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const morai_msgs::msg::EgoVehicleStatus & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  morai_msgs::msg::EgoVehicleStatus & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = morai_msgs::msg::EgoVehicleStatus;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const morai_msgs::msg::EgoVehicleStatus *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<morai_msgs::msg::EgoVehicleStatus *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _EgoVehicleStatus__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const morai_msgs::msg::EgoVehicleStatus *>(
...
static size_t _EgoVehicleStatus__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_EgoVehicleStatus(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _EgoVehicleStatus__callbacks = {
  "morai_msgs::msg",
  "EgoVehicleStatus",
...
static rosidl_message_type_support_t _EgoVehicleStatus__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_EgoVehicleStatus__callbacks,
...
{
  return &morai_msgs::msg::typesupport_fastrtps_cpp::_EgoVehicleStatus__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, morai_msgs, msg, EgoVehicleStatus)() {
  return &morai_msgs::msg::typesupport_fastrtps_cpp::_EgoVehicleStatus__handle;
}
