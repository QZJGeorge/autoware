...
#include "morai_msgs/msg/detail/sync_mode_info__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const morai_msgs::msg::SyncModeInfo & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  morai_msgs::msg::SyncModeInfo & ros_message)
{
  // Member: master_id
  cdr >> ros_message.master_id;
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_morai_msgs
max_serialized_size_SyncModeInfo(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = morai_msgs::msg::SyncModeInfo;
    is_plain =
      (
      offsetof(DataType, can_send_tick) +
      last_member_size
      ) == ret_val;
  }
...
{
  auto typed_message =
    static_cast<const morai_msgs::msg::SyncModeInfo *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<morai_msgs::msg::SyncModeInfo *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _SyncModeInfo__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const morai_msgs::msg::SyncModeInfo *>(
...
static size_t _SyncModeInfo__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_SyncModeInfo(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _SyncModeInfo__callbacks = {
  "morai_msgs::msg",
  "SyncModeInfo",
...
static rosidl_message_type_support_t _SyncModeInfo__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_SyncModeInfo__callbacks,
...
{
  return &morai_msgs::msg::typesupport_fastrtps_cpp::_SyncModeInfo__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, morai_msgs, msg, SyncModeInfo)() {
  return &morai_msgs::msg::typesupport_fastrtps_cpp::_SyncModeInfo__handle;
}
