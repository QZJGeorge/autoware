  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = morai_msgs::msg::Lamps;
    is_plain =
      (
      offsetof(DataType, emergency_signal) +
      last_member_size
      ) == ret_val;
  }
...
static size_t _Lamps__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_Lamps(full_bounded, is_plain, 0);
