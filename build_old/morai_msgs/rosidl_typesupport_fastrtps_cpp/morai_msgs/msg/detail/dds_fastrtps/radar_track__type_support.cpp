...
#include "morai_msgs/msg/detail/radar_track__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const morai_msgs::msg::RadarTrack & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  morai_msgs::msg::RadarTrack & ros_message)
{
  // Member: uuid
  cdr >> ros_message.uuid;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = morai_msgs::msg::RadarTrack;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const morai_msgs::msg::RadarTrack *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<morai_msgs::msg::RadarTrack *>(
    untyped_ros_message);
...
{
  return &morai_msgs::msg::typesupport_fastrtps_cpp::_RadarTrack__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, morai_msgs, msg, RadarTrack)() {
  return &morai_msgs::msg::typesupport_fastrtps_cpp::_RadarTrack__handle;
}
