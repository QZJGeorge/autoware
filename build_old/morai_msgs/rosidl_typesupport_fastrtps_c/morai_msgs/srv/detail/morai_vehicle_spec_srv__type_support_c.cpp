  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = morai_msgs__srv__MoraiVehicleSpecSrv_Request;
    is_plain =
      (
...
static size_t _MoraiVehicleSpecSrv_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_morai_msgs__srv__MoraiVehicleSpecSrv_Request(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = morai_msgs__srv__MoraiVehicleSpecSrv_Response;
    is_plain =
      (
...
static size_t _MoraiVehicleSpecSrv_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_morai_msgs__srv__MoraiVehicleSpecSrv_Response(
    full_bounded, is_plain, 0);
