...
#include "morai_msgs/msg/detail/replay_info__rosidl_typesupport_fastrtps_c.h"
...
using _ReplayInfo__ros_msg_type = morai_msgs__msg__ReplayInfo;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _ReplayInfo__ros_msg_type * ros_message = static_cast<const _ReplayInfo__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
  ...
  // Field name: ego_brake
  {
    cdr << ros_message->ego_brake;
  }

  // Field name: ego_steer
  {
  ...
  void * untyped_ros_message)
{
  ...
  _ReplayInfo__ros_msg_type * ros_message = static_cast<_ReplayInfo__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
size_t get_serialized_size_morai_msgs__msg__ReplayInfo(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _ReplayInfo__ros_msg_type * ros_message = static_cast<const _ReplayInfo__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _ReplayInfo__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_morai_msgs__msg__ReplayInfo(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_morai_msgs
size_t max_serialized_size_morai_msgs__msg__ReplayInfo(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = morai_msgs__msg__ReplayInfo;
    is_plain =
      (
...
static size_t _ReplayInfo__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_morai_msgs__msg__ReplayInfo(
...
static message_type_support_callbacks_t __callbacks_ReplayInfo = {
  "morai_msgs::msg",
  "ReplayInfo",
...
static rosidl_message_type_support_t _ReplayInfo__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_ReplayInfo,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, morai_msgs, msg, ReplayInfo)() {
  return &_ReplayInfo__type_support;
}
