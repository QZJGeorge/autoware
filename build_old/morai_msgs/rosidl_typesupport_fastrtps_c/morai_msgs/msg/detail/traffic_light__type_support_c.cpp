...
#include "morai_msgs/msg/detail/traffic_light__rosidl_typesupport_fastrtps_c.h"
...
using _TrafficLight__ros_msg_type = morai_msgs__msg__TrafficLight;
...
size_t get_serialized_size_morai_msgs__msg__TrafficLight(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _TrafficLight__ros_msg_type * ros_message = static_cast<const _TrafficLight__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _TrafficLight__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_morai_msgs__msg__TrafficLight(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_morai_msgs
size_t max_serialized_size_morai_msgs__msg__TrafficLight(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = morai_msgs__msg__TrafficLight;
    is_plain =
      (
      offsetof(DataType, num_of_light) +
      last_member_size
      ) == ret_val;
  }
...
static size_t _TrafficLight__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_morai_msgs__msg__TrafficLight(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, morai_msgs, msg, TrafficLight)() {
