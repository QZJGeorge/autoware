...
#include "morai_msgs/msg/detail/radar_detection__rosidl_typesupport_fastrtps_c.h"
...
using _RadarDetection__ros_msg_type = morai_msgs__msg__RadarDetection;
...
static uint32_t _RadarDetection__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_morai_msgs__msg__RadarDetection(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = morai_msgs__msg__RadarDetection;
    is_plain =
      (
      offsetof(DataType, amplitude) +
      last_member_size
      ) == ret_val;
  }
...
static size_t _RadarDetection__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_morai_msgs__msg__RadarDetection(
