...
#include "morai_msgs/msg/detail/wait_for_tick__rosidl_typesupport_fastrtps_c.h"
...
using _WaitForTick__ros_msg_type = morai_msgs__msg__WaitForTick;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _WaitForTick__ros_msg_type * ros_message = static_cast<const _WaitForTick__ros_msg_type *>(untyped_ros_message);
  // Field name: user_id
  {
  ...
  void * untyped_ros_message)
{
  ...
  _WaitForTick__ros_msg_type * ros_message = static_cast<_WaitForTick__ros_msg_type *>(untyped_ros_message);
  // Field name: user_id
  {
    std::string tmp;
    cdr >> tmp;
...
static uint32_t _WaitForTick__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_morai_msgs__msg__WaitForTick(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = morai_msgs__msg__WaitForTick;
    is_plain =
      (
...
static size_t _WaitForTick__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_morai_msgs__msg__WaitForTick(
...
static message_type_support_callbacks_t __callbacks_WaitForTick = {
  "morai_msgs::msg",
  "WaitForTick",
