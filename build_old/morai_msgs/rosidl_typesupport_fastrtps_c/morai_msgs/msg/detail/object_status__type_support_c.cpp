...
#include "morai_msgs/msg/detail/object_status__rosidl_typesupport_fastrtps_c.h"
...
#include "geometry_msgs/msg/detail/vector3__functions.h"  // acceleration, position, size, velocity
...
using _ObjectStatus__ros_msg_type = morai_msgs__msg__ObjectStatus;
...
static uint32_t _ObjectStatus__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_morai_msgs__msg__ObjectStatus(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = morai_msgs__msg__ObjectStatus;
    is_plain =
      (
...
static size_t _ObjectStatus__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_morai_msgs__msg__ObjectStatus(
