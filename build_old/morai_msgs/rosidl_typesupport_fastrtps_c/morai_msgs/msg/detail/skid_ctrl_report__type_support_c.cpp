...
#include "morai_msgs/msg/detail/skid_ctrl_report__rosidl_typesupport_fastrtps_c.h"
...
#include "geometry_msgs/msg/detail/vector3__functions.h"  // acceleration, angular_velocity, position, velocity
#include "morai_msgs/msg/detail/skid_model__functions.h"  // skid_model_report
...
using _SkidCtrlReport__ros_msg_type = morai_msgs__msg__SkidCtrlReport;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _SkidCtrlReport__ros_msg_type * ros_message = static_cast<const _SkidCtrlReport__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
  ...
  // Field name: skid_model_report
  {
    ...
    if (!callbacks->cdr_serialize(
        &ros_message->skid_model_report, cdr))
    {
      return false;
    }
  }
  ...
  void * untyped_ros_message)
{
  ...
  _SkidCtrlReport__ros_msg_type * ros_message = static_cast<_SkidCtrlReport__ros_msg_type *>(untyped_ros_message);
  // Field name: header
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
size_t get_serialized_size_morai_msgs__msg__SkidCtrlReport(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _SkidCtrlReport__ros_msg_type * ros_message = static_cast<const _SkidCtrlReport__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _SkidCtrlReport__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_morai_msgs__msg__SkidCtrlReport(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_morai_msgs
size_t max_serialized_size_morai_msgs__msg__SkidCtrlReport(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = morai_msgs__msg__SkidCtrlReport;
    is_plain =
      (
      offsetof(DataType, skid_model_report) +
      last_member_size
      ) == ret_val;
  }
...
static size_t _SkidCtrlReport__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_morai_msgs__msg__SkidCtrlReport(
...
static message_type_support_callbacks_t __callbacks_SkidCtrlReport = {
  "morai_msgs::msg",
  "SkidCtrlReport",
...
static rosidl_message_type_support_t _SkidCtrlReport__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_SkidCtrlReport,
  get_message_typesupport_handle_function,
};

const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, morai_msgs, msg, SkidCtrlReport)() {
  return &_SkidCtrlReport__type_support;
}
