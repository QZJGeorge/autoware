...
#include "morai_msgs/msg/detail/sync_mode_cmd__rosidl_typesupport_fastrtps_c.h"
...
using _SyncModeCmd__ros_msg_type = morai_msgs__msg__SyncModeCmd;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _SyncModeCmd__ros_msg_type * ros_message = static_cast<const _SyncModeCmd__ros_msg_type *>(untyped_ros_message);
  // Field name: user_id
  {
  ...
  void * untyped_ros_message)
{
  ...
  _SyncModeCmd__ros_msg_type * ros_message = static_cast<_SyncModeCmd__ros_msg_type *>(untyped_ros_message);
  // Field name: user_id
  {
    std::string tmp;
    cdr >> tmp;
...
static uint32_t _SyncModeCmd__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_morai_msgs__msg__SyncModeCmd(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = morai_msgs__msg__SyncModeCmd;
    is_plain =
      (
...
static size_t _SyncModeCmd__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_morai_msgs__msg__SyncModeCmd(
...
static message_type_support_callbacks_t __callbacks_SyncModeCmd = {
  "morai_msgs::msg",
  "SyncModeCmd",
