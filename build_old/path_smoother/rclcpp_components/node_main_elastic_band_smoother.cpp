...
#define NODE_MAIN_LOGGER_NAME "elastic_band_smoother"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libpath_smoother.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<path_smoother::ElasticBandSmoother>";
