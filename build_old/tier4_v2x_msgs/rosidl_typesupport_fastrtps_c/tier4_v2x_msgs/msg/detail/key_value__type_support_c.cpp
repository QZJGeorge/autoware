...
#include "tier4_v2x_msgs/msg/detail/key_value__rosidl_typesupport_fastrtps_c.h"
...
using _KeyValue__ros_msg_type = tier4_v2x_msgs__msg__KeyValue;
...
static uint32_t _KeyValue__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_tier4_v2x_msgs__msg__KeyValue(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = tier4_v2x_msgs__msg__KeyValue;
    is_plain =
      (
...
static size_t _KeyValue__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_tier4_v2x_msgs__msg__KeyValue(
