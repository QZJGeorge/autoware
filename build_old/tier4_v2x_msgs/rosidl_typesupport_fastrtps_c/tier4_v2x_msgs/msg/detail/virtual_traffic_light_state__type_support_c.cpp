...
#include "tier4_v2x_msgs/msg/detail/virtual_traffic_light_state__rosidl_typesupport_fastrtps_c.h"
...
using _VirtualTrafficLightState__ros_msg_type = tier4_v2x_msgs__msg__VirtualTrafficLightState;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _VirtualTrafficLightState__ros_msg_type * ros_message = static_cast<const _VirtualTrafficLightState__ros_msg_type *>(untyped_ros_message);
  // Field name: stamp
  {
  ...
  void * untyped_ros_message)
{
  ...
  _VirtualTrafficLightState__ros_msg_type * ros_message = static_cast<_VirtualTrafficLightState__ros_msg_type *>(untyped_ros_message);
  // Field name: stamp
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
static uint32_t _VirtualTrafficLightState__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_tier4_v2x_msgs__msg__VirtualTrafficLightState(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = tier4_v2x_msgs__msg__VirtualTrafficLightState;
    is_plain =
      (
      offsetof(DataType, is_finalized) +
      last_member_size
      ) == ret_val;
  }
...
static size_t _VirtualTrafficLightState__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_tier4_v2x_msgs__msg__VirtualTrafficLightState(
...
static message_type_support_callbacks_t __callbacks_VirtualTrafficLightState = {
  "tier4_v2x_msgs::msg",
...
static rosidl_message_type_support_t _VirtualTrafficLightState__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_VirtualTrafficLightState,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, tier4_v2x_msgs, msg, VirtualTrafficLightState)() {
  return &_VirtualTrafficLightState__type_support;
}
