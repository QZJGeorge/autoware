...
#include "tier4_v2x_msgs/msg/detail/virtual_traffic_light_state_array__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const tier4_v2x_msgs::msg::VirtualTrafficLightState &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  ...
  size_t current_alignment)
{
  ...
  // Member: states
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        tier4_v2x_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_VirtualTrafficLightState(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = tier4_v2x_msgs::msg::VirtualTrafficLightStateArray;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const tier4_v2x_msgs::msg::VirtualTrafficLightStateArray *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<tier4_v2x_msgs::msg::VirtualTrafficLightStateArray *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _VirtualTrafficLightStateArray__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const tier4_v2x_msgs::msg::VirtualTrafficLightStateArray *>(
...
static size_t _VirtualTrafficLightStateArray__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_VirtualTrafficLightStateArray(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _VirtualTrafficLightStateArray__callbacks = {
  "tier4_v2x_msgs::msg",
...
static rosidl_message_type_support_t _VirtualTrafficLightStateArray__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_VirtualTrafficLightStateArray__callbacks,
...
get_message_type_support_handle<tier4_v2x_msgs::msg::VirtualTrafficLightStateArray>()
{
  return &tier4_v2x_msgs::msg::typesupport_fastrtps_cpp::_VirtualTrafficLightStateArray__handle;
}
