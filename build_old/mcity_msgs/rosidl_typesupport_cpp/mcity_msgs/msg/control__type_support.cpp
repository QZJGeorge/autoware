...
static const _Control_type_support_symbol_names_t _Control_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, mcity_msgs, msg, Control)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, mcity_msgs, msg, Control)),
  }
};
...
get_message_type_support_handle<mcity_msgs::msg::Control>()
{
  return &::mcity_msgs::msg::rosidl_typesupport_cpp::Control_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, mcity_msgs, msg, Control)() {
  return get_message_type_support_handle<mcity_msgs::msg::Control>();
}
