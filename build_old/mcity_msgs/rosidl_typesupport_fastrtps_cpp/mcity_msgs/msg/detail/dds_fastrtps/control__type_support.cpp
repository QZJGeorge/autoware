...
#include "mcity_msgs/msg/detail/control__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = mcity_msgs::msg::Control;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const mcity_msgs::msg::Control *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<mcity_msgs::msg::Control *>(
    untyped_ros_message);
...
{
  return &mcity_msgs::msg::typesupport_fastrtps_cpp::_Control__handle;
}
