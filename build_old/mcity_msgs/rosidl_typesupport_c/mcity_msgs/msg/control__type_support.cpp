...
static const _Control_type_support_symbol_names_t _Control_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, mcity_msgs, msg, Control)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, mcity_msgs, msg, Control)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, mcity_msgs, msg, Control)() {
  return &::mcity_msgs::msg::rosidl_typesupport_c::Control_message_type_support_handle;
}
