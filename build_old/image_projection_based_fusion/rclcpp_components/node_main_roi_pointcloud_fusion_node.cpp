...
#define NODE_MAIN_LOGGER_NAME "roi_pointcloud_fusion_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libimage_projection_based_fusion.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<image_projection_based_fusion::RoiPointCloudFusionNode>";
