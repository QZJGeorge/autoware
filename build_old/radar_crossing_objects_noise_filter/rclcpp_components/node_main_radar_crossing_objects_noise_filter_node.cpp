...
#define NODE_MAIN_LOGGER_NAME "radar_crossing_objects_noise_filter_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libradar_crossing_objects_noise_filter_node_component.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<radar_crossing_objects_noise_filter::RadarCrossingObjectsNoiseFilterNode>";
