...
#define NODE_MAIN_LOGGER_NAME "vehicle_cmd_gate_exe"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libvehicle_cmd_gate_node.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<vehicle_cmd_gate::VehicleCmdGate>";
