...
#define NODE_MAIN_LOGGER_NAME "mcity_localization"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libmcity_localization_component.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<mcity_localization::McityLocalization>";
