...
#include "tier4_perception_msgs/msg/detail/traffic_light_roi__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const tier4_perception_msgs::msg::TrafficLightRoi & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  tier4_perception_msgs::msg::TrafficLightRoi & ros_message)
{
  // Member: roi
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = tier4_perception_msgs::msg::TrafficLightRoi;
    is_plain =
      (
      offsetof(DataType, traffic_light_id) +
      last_member_size
      ) == ret_val;
  }
...
{
  auto typed_message =
    static_cast<const tier4_perception_msgs::msg::TrafficLightRoi *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<tier4_perception_msgs::msg::TrafficLightRoi *>(
    untyped_ros_message);
...
get_message_type_support_handle<tier4_perception_msgs::msg::TrafficLightRoi>()
{
  return &tier4_perception_msgs::msg::typesupport_fastrtps_cpp::_TrafficLightRoi__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, tier4_perception_msgs, msg, TrafficLightRoi)() {
  return &tier4_perception_msgs::msg::typesupport_fastrtps_cpp::_TrafficLightRoi__handle;
}
