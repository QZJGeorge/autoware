...
#include "tier4_perception_msgs/msg/detail/traffic_signal_array__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const tier4_perception_msgs::msg::TrafficSignal &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  tier4_perception_msgs::msg::TrafficSignal &);
size_t get_serialized_size(
  const tier4_perception_msgs::msg::TrafficSignal &,
  size_t current_alignment);
size_t
...
cdr_serialize(
  const tier4_perception_msgs::msg::TrafficSignalArray & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  tier4_perception_msgs::msg::TrafficSignalArray & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  // Member: signals
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        tier4_perception_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_TrafficSignal(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = tier4_perception_msgs::msg::TrafficSignalArray;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const tier4_perception_msgs::msg::TrafficSignalArray *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<tier4_perception_msgs::msg::TrafficSignalArray *>(
    untyped_ros_message);
...
{
  return &tier4_perception_msgs::msg::typesupport_fastrtps_cpp::_TrafficSignalArray__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, tier4_perception_msgs, msg, TrafficSignalArray)() {
  return &tier4_perception_msgs::msg::typesupport_fastrtps_cpp::_TrafficSignalArray__handle;
}
