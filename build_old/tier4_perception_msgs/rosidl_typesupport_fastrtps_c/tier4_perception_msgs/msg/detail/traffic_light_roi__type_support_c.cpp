...
#include "tier4_perception_msgs/msg/detail/traffic_light_roi__rosidl_typesupport_fastrtps_c.h"
...
using _TrafficLightRoi__ros_msg_type = tier4_perception_msgs__msg__TrafficLightRoi;
...
static uint32_t _TrafficLightRoi__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_tier4_perception_msgs__msg__TrafficLightRoi(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = tier4_perception_msgs__msg__TrafficLightRoi;
    is_plain =
      (
...
static size_t _TrafficLightRoi__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_tier4_perception_msgs__msg__TrafficLightRoi(
