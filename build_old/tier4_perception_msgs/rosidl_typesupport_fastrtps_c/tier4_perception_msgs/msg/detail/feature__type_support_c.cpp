...
#include "tier4_perception_msgs/msg/detail/feature__rosidl_typesupport_fastrtps_c.h"
...
using _Feature__ros_msg_type = tier4_perception_msgs__msg__Feature;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _Feature__ros_msg_type * ros_message = static_cast<const _Feature__ros_msg_type *>(untyped_ros_message);
  // Field name: cluster
  {
  ...
  void * untyped_ros_message)
{
  ...
  _Feature__ros_msg_type * ros_message = static_cast<_Feature__ros_msg_type *>(untyped_ros_message);
  // Field name: cluster
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
static uint32_t _Feature__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_tier4_perception_msgs__msg__Feature(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = tier4_perception_msgs__msg__Feature;
    is_plain =
      (
...
static size_t _Feature__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_tier4_perception_msgs__msg__Feature(
...
static message_type_support_callbacks_t __callbacks_Feature = {
...
static rosidl_message_type_support_t _Feature__type_support = {
