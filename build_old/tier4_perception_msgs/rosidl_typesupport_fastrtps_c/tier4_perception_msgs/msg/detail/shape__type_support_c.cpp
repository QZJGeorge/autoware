...
#include "tier4_perception_msgs/msg/detail/shape__rosidl_typesupport_fastrtps_c.h"
...
using _Shape__ros_msg_type = tier4_perception_msgs__msg__Shape;
...
static uint32_t _Shape__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_tier4_perception_msgs__msg__Shape(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = tier4_perception_msgs__msg__Shape;
    is_plain =
      (
...
static size_t _Shape__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_tier4_perception_msgs__msg__Shape(
