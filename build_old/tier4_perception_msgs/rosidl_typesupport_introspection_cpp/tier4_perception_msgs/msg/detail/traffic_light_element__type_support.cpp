...
{
  new (message_memory) tier4_perception_msgs::msg::TrafficLightElement(_init);
}

void TrafficLightElement_fini_function(void * message_memory)
{
  auto typed_message = static_cast<tier4_perception_msgs::msg::TrafficLightElement *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember TrafficLightElement_message_member_array[4] = {
  {
    ...
    offsetof(tier4_perception_msgs::msg::TrafficLightElement, color),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(tier4_perception_msgs::msg::TrafficLightElement, shape),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(tier4_perception_msgs::msg::TrafficLightElement, status),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(tier4_perception_msgs::msg::TrafficLightElement, confidence),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers TrafficLightElement_message_members = {
  ...
  4,  // number of fields
  sizeof(tier4_perception_msgs::msg::TrafficLightElement),
...
{
  return &::tier4_perception_msgs::msg::rosidl_typesupport_introspection_cpp::TrafficLightElement_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, tier4_perception_msgs, msg, TrafficLightElement)() {
  return &::tier4_perception_msgs::msg::rosidl_typesupport_introspection_cpp::TrafficLightElement_message_type_support_handle;
}
