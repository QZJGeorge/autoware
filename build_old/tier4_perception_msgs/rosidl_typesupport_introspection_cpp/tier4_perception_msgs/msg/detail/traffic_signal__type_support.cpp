...
{
  new (message_memory) tier4_perception_msgs::msg::TrafficSignal(_init);
}

void TrafficSignal_fini_function(void * message_memory)
{
  auto typed_message = static_cast<tier4_perception_msgs::msg::TrafficSignal *>(message_memory);
  typed_message->~TrafficSignal();
}

size_t size_function__TrafficSignal__elements(const void * untyped_member)
{
  const auto * member = reinterpret_cast<const std::vector<tier4_perception_msgs::msg::TrafficLightElement> *>(untyped_member);
  return member->size();
}
...
{
  const auto & member =
    *reinterpret_cast<const std::vector<tier4_perception_msgs::msg::TrafficLightElement> *>(untyped_member);
  return &member[index];
}
...
{
  auto & member =
    *reinterpret_cast<std::vector<tier4_perception_msgs::msg::TrafficLightElement> *>(untyped_member);
  return &member[index];
}
...
{
  const auto & item = *reinterpret_cast<const tier4_perception_msgs::msg::TrafficLightElement *>(
    get_const_function__TrafficSignal__elements(untyped_member, index));
  auto & value = *reinterpret_cast<tier4_perception_msgs::msg::TrafficLightElement *>(untyped_value);
  value = item;
}
...
{
  auto & item = *reinterpret_cast<tier4_perception_msgs::msg::TrafficLightElement *>(
    get_function__TrafficSignal__elements(untyped_member, index));
  const auto & value = *reinterpret_cast<const tier4_perception_msgs::msg::TrafficLightElement *>(untyped_value);
  item = value;
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember TrafficSignal_message_member_array[2] = {
  {
    ...
    offsetof(tier4_perception_msgs::msg::TrafficSignal, traffic_light_id),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // upper bound of string
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<tier4_perception_msgs::msg::TrafficLightElement>(),  // members of sub message
    true,  // is array
    0,  // array size
    false,  // is upper bound
    offsetof(tier4_perception_msgs::msg::TrafficSignal, elements),  // bytes offset in struct
    nullptr,  // default value
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers TrafficSignal_message_members = {
  ...
  2,  // number of fields
  sizeof(tier4_perception_msgs::msg::TrafficSignal),
...
{
  return &::tier4_perception_msgs::msg::rosidl_typesupport_introspection_cpp::TrafficSignal_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, tier4_perception_msgs, msg, TrafficSignal)() {
  return &::tier4_perception_msgs::msg::rosidl_typesupport_introspection_cpp::TrafficSignal_message_type_support_handle;
}
