...
static const _TrafficLightRoiArray_type_support_symbol_names_t _TrafficLightRoiArray_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, tier4_perception_msgs, msg, TrafficLightRoiArray)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, tier4_perception_msgs, msg, TrafficLightRoiArray)),
  }
};
...
{
  return &::tier4_perception_msgs::msg::rosidl_typesupport_cpp::TrafficLightRoiArray_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, tier4_perception_msgs, msg, TrafficLightRoiArray)() {
  return get_message_type_support_handle<tier4_perception_msgs::msg::TrafficLightRoiArray>();
}
