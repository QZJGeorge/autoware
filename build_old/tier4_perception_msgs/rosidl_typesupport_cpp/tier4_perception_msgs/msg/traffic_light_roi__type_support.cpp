...
static const _TrafficLightRoi_type_support_symbol_names_t _TrafficLightRoi_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, tier4_perception_msgs, msg, TrafficLightRoi)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, tier4_perception_msgs, msg, TrafficLightRoi)),
  }
};
...
{
  return &::tier4_perception_msgs::msg::rosidl_typesupport_cpp::TrafficLightRoi_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, tier4_perception_msgs, msg, TrafficLightRoi)() {
  return get_message_type_support_handle<tier4_perception_msgs::msg::TrafficLightRoi>();
}
