...
static const _TrafficLightRoiArray_type_support_symbol_names_t _TrafficLightRoiArray_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, tier4_perception_msgs, msg, TrafficLightRoiArray)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, tier4_perception_msgs, msg, TrafficLightRoiArray)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, tier4_perception_msgs, msg, TrafficLightRoiArray)() {
  return &::tier4_perception_msgs::msg::rosidl_typesupport_c::TrafficLightRoiArray_message_type_support_handle;
}
