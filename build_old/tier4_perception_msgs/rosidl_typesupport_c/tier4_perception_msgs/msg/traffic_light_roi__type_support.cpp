...
static const _TrafficLightRoi_type_support_symbol_names_t _TrafficLightRoi_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, tier4_perception_msgs, msg, TrafficLightRoi)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, tier4_perception_msgs, msg, TrafficLightRoi)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, tier4_perception_msgs, msg, TrafficLightRoi)() {
  return &::tier4_perception_msgs::msg::rosidl_typesupport_c::TrafficLightRoi_message_type_support_handle;
}
