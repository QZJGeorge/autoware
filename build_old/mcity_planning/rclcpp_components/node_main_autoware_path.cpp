...
#define NODE_MAIN_LOGGER_NAME "autoware_path"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libautoware_path_component.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<autoware_path::AutowarePath>";
