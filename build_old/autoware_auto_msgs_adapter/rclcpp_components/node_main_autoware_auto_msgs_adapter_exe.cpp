...
#define NODE_MAIN_LOGGER_NAME "autoware_auto_msgs_adapter_exe"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libautoware_auto_msgs_adapter_node.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<autoware_auto_msgs_adapter::AutowareAutoMsgsAdapterNode>";
