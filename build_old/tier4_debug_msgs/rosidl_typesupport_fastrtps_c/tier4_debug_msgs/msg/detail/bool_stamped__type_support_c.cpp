...
#include "tier4_debug_msgs/msg/detail/bool_stamped__rosidl_typesupport_fastrtps_c.h"
...
using _BoolStamped__ros_msg_type = tier4_debug_msgs__msg__BoolStamped;
...
size_t get_serialized_size_tier4_debug_msgs__msg__BoolStamped(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _BoolStamped__ros_msg_type * ros_message = static_cast<const _BoolStamped__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _BoolStamped__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_tier4_debug_msgs__msg__BoolStamped(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_tier4_debug_msgs
size_t max_serialized_size_tier4_debug_msgs__msg__BoolStamped(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = tier4_debug_msgs__msg__BoolStamped;
    is_plain =
      (
...
static size_t _BoolStamped__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_tier4_debug_msgs__msg__BoolStamped(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, tier4_debug_msgs, msg, BoolStamped)() {
