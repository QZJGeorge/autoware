...
#include "tier4_debug_msgs/msg/detail/float64_multi_array_stamped__rosidl_typesupport_fastrtps_c.h"
...
using _Float64MultiArrayStamped__ros_msg_type = tier4_debug_msgs__msg__Float64MultiArrayStamped;
...
size_t get_serialized_size_tier4_debug_msgs__msg__Float64MultiArrayStamped(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Float64MultiArrayStamped__ros_msg_type * ros_message = static_cast<const _Float64MultiArrayStamped__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _Float64MultiArrayStamped__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_tier4_debug_msgs__msg__Float64MultiArrayStamped(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_tier4_debug_msgs
size_t max_serialized_size_tier4_debug_msgs__msg__Float64MultiArrayStamped(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = tier4_debug_msgs__msg__Float64MultiArrayStamped;
    is_plain =
      (
...
static size_t _Float64MultiArrayStamped__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_tier4_debug_msgs__msg__Float64MultiArrayStamped(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, tier4_debug_msgs, msg, Float64MultiArrayStamped)() {
