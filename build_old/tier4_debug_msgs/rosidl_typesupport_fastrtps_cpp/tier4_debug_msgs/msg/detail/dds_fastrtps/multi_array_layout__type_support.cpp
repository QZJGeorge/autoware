...
#include "tier4_debug_msgs/msg/detail/multi_array_layout__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const tier4_debug_msgs::msg::MultiArrayDimension &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  tier4_debug_msgs::msg::MultiArrayDimension &);
...
cdr_serialize(
  const tier4_debug_msgs::msg::MultiArrayLayout & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  tier4_debug_msgs::msg::MultiArrayLayout & ros_message)
{
  // Member: dim
  {
    uint32_t cdrSize;
  ...
  size_t current_alignment)
{
  ...
  // Member: dim
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        tier4_debug_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_MultiArrayDimension(
  ...
  if (is_plain) {
    ...
    using DataType = tier4_debug_msgs::msg::MultiArrayLayout;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const tier4_debug_msgs::msg::MultiArrayLayout *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<tier4_debug_msgs::msg::MultiArrayLayout *>(
    untyped_ros_message);
...
get_message_type_support_handle<tier4_debug_msgs::msg::MultiArrayLayout>()
{
  return &tier4_debug_msgs::msg::typesupport_fastrtps_cpp::_MultiArrayLayout__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, tier4_debug_msgs, msg, MultiArrayLayout)() {
  return &tier4_debug_msgs::msg::typesupport_fastrtps_cpp::_MultiArrayLayout__handle;
}
