...
#include "tier4_debug_msgs/msg/detail/int32_stamped__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const tier4_debug_msgs::msg::Int32Stamped & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  tier4_debug_msgs::msg::Int32Stamped & ros_message)
{
  // Member: stamp
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = tier4_debug_msgs::msg::Int32Stamped;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const tier4_debug_msgs::msg::Int32Stamped *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<tier4_debug_msgs::msg::Int32Stamped *>(
    untyped_ros_message);
...
get_message_type_support_handle<tier4_debug_msgs::msg::Int32Stamped>()
{
  return &tier4_debug_msgs::msg::typesupport_fastrtps_cpp::_Int32Stamped__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, tier4_debug_msgs, msg, Int32Stamped)() {
  return &tier4_debug_msgs::msg::typesupport_fastrtps_cpp::_Int32Stamped__handle;
}
