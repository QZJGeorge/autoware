...
#define NODE_MAIN_LOGGER_NAME "traffic_light_multi_camera_fusion_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libtraffic_light_multi_camera_fusion.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<traffic_light::MultiCameraFusion>";
