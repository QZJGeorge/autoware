...
#define NODE_MAIN_LOGGER_NAME "radar_object_clustering_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libradar_object_clustering_node_component.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<radar_object_clustering::RadarObjectClusteringNode>";
