...
#define NODE_MAIN_LOGGER_NAME "cluster_merger_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libcluster_merger_node_component.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<cluster_merger::ClusterMergerNode>";
