...
#define NODE_MAIN_LOGGER_NAME "traffic_light_fine_detector_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libtraffic_light_fine_detector_nodelet.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<traffic_light::TrafficLightFineDetectorNodelet>";
