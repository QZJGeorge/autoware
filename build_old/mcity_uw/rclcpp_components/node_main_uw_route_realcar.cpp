...
#define NODE_MAIN_LOGGER_NAME "uw_route_realcar"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libuw_route_realcar_component.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<uw_route_realcar::UwRouteRealcar>";
