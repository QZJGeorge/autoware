...
#define NODE_MAIN_LOGGER_NAME "cav_state_converter"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libcav_state_converter_component.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<cav_state_converter::CavStateConverter>";
