...
#define NODE_MAIN_LOGGER_NAME "occ_grid_converter"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libocc_grid_converter_component.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<occ_grid_converter::OccGridConverter>";
