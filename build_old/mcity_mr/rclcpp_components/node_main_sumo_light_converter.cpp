...
#define NODE_MAIN_LOGGER_NAME "sumo_light_converter"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libsumo_light_converter_component.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<sumo_light_converter::SumoLightConverter>";
