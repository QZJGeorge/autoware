...
#define NODE_MAIN_LOGGER_NAME "carla_to_local"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libcarla_to_local_component.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<carla_to_local::CarlaToLocal>";
