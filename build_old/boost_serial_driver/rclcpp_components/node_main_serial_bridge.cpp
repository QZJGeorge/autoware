...
#define NODE_MAIN_LOGGER_NAME "serial_bridge"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libboost_serial_driver_nodes.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<drivers::boost_serial_driver::SerialBridgeNode>";
