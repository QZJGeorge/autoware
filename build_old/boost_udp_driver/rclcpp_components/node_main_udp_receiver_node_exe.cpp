...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libboost_udp_driver_nodes.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<drivers::boost_udp_driver::UdpReceiverNode>";
