...
static const _PandarPacket_type_support_symbol_names_t _PandarPacket_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, pandar_msgs, msg, PandarPacket)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, pandar_msgs, msg, PandarPacket)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, pandar_msgs, msg, PandarPacket)() {
  return &::pandar_msgs::msg::rosidl_typesupport_c::PandarPacket_message_type_support_handle;
}
