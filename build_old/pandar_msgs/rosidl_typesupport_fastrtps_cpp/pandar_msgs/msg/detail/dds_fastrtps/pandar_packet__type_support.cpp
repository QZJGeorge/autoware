...
#include "pandar_msgs/msg/detail/pandar_packet__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const pandar_msgs::msg::PandarPacket & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  pandar_msgs::msg::PandarPacket & ros_message)
{
  // Member: stamp
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = pandar_msgs::msg::PandarPacket;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const pandar_msgs::msg::PandarPacket *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<pandar_msgs::msg::PandarPacket *>(
    untyped_ros_message);
...
{
  return &pandar_msgs::msg::typesupport_fastrtps_cpp::_PandarPacket__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, pandar_msgs, msg, PandarPacket)() {
  return &pandar_msgs::msg::typesupport_fastrtps_cpp::_PandarPacket__handle;
}
