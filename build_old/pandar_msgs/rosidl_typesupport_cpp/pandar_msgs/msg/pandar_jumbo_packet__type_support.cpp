...
static const _PandarJumboPacket_type_support_symbol_names_t _PandarJumboPacket_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, pandar_msgs, msg, PandarJumboPacket)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, pandar_msgs, msg, PandarJumboPacket)),
  }
};
...
{
  return &::pandar_msgs::msg::rosidl_typesupport_cpp::PandarJumboPacket_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, pandar_msgs, msg, PandarJumboPacket)() {
  return get_message_type_support_handle<pandar_msgs::msg::PandarJumboPacket>();
}
