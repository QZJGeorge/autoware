...
bool pandar_msgs__msg__pandar_jumbo_packet__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("pandar_msgs.msg._pandar_jumbo_packet.PandarJumboPacket", full_classname_dest, 54) == 0);
  }
  pandar_msgs__msg__PandarJumboPacket * ros_message = _ros_message;
  {  // stamp
...
{
  /* NOTE(esteve): Call constructor of PandarJumboPacket */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("pandar_msgs.msg._pandar_jumbo_packet");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "PandarJumboPacket");
