...
static const _ParticleArray_type_support_symbol_names_t _ParticleArray_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, yabloc_particle_filter, msg, ParticleArray)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, yabloc_particle_filter, msg, ParticleArray)),
  }
};
...
{
  return &::yabloc_particle_filter::msg::rosidl_typesupport_cpp::ParticleArray_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, yabloc_particle_filter, msg, ParticleArray)() {
  return get_message_type_support_handle<yabloc_particle_filter::msg::ParticleArray>();
}
