...
#include "yabloc_particle_filter/msg/detail/particle__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const yabloc_particle_filter::msg::Particle & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  yabloc_particle_filter::msg::Particle & ros_message)
{
  // Member: weight
  cdr >> ros_message.weight;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = yabloc_particle_filter::msg::Particle;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const yabloc_particle_filter::msg::Particle *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<yabloc_particle_filter::msg::Particle *>(
    untyped_ros_message);
...
{
  return &yabloc_particle_filter::msg::typesupport_fastrtps_cpp::_Particle__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, yabloc_particle_filter, msg, Particle)() {
  return &yabloc_particle_filter::msg::typesupport_fastrtps_cpp::_Particle__handle;
}
