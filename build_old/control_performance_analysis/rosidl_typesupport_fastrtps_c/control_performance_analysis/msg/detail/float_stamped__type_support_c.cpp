...
#include "control_performance_analysis/msg/detail/float_stamped__rosidl_typesupport_fastrtps_c.h"
...
using _FloatStamped__ros_msg_type = control_performance_analysis__msg__FloatStamped;
...
static uint32_t _FloatStamped__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_control_performance_analysis__msg__FloatStamped(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = control_performance_analysis__msg__FloatStamped;
    is_plain =
      (
...
static size_t _FloatStamped__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_control_performance_analysis__msg__FloatStamped(
