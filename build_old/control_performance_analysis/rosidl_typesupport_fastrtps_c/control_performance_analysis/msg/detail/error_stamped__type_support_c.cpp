  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = control_performance_analysis__msg__ErrorStamped;
    is_plain =
      (
...
static size_t _ErrorStamped__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_control_performance_analysis__msg__ErrorStamped(
