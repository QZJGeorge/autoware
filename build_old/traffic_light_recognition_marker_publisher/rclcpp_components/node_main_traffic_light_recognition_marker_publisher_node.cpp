...
#define NODE_MAIN_LOGGER_NAME "traffic_light_recognition_marker_publisher_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libtraffic_light_recognition_marker_publisher.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<TrafficLightRecognitionMarkerPublisher>";
