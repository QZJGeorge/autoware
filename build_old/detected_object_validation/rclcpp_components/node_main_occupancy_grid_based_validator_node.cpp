...
#define NODE_MAIN_LOGGER_NAME "occupancy_grid_based_validator_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "liboccupancy_grid_based_validator.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<occupancy_grid_based_validator::OccupancyGridBasedValidator>";
