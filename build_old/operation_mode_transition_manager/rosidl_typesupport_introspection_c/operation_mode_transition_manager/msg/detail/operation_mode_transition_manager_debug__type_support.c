...
void operation_mode_transition_manager__msg__OperationModeTransitionManagerDebug__rosidl_typesupport_introspection_c__OperationModeTransitionManagerDebug_init_function(
...
void operation_mode_transition_manager__msg__OperationModeTransitionManagerDebug__rosidl_typesupport_introspection_c__OperationModeTransitionManagerDebug_fini_function(void * message_memory)
{
  operation_mode_transition_manager__msg__OperationModeTransitionManagerDebug__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember operation_mode_transition_manager__msg__OperationModeTransitionManagerDebug__rosidl_typesupport_introspection_c__OperationModeTransitionManagerDebug_message_member_array[24] = {
  {
    "stamp",  // name
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(operation_mode_transition_manager__msg__OperationModeTransitionManagerDebug, status),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(operation_mode_transition_manager__msg__OperationModeTransitionManagerDebug, in_autoware_control),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(operation_mode_transition_manager__msg__OperationModeTransitionManagerDebug, in_transition),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers operation_mode_transition_manager__msg__OperationModeTransitionManagerDebug__rosidl_typesupport_introspection_c__OperationModeTransitionManagerDebug_message_members = {
  ...
  operation_mode_transition_manager__msg__OperationModeTransitionManagerDebug__rosidl_typesupport_introspection_c__OperationModeTransitionManagerDebug_message_member_array,  // message members
  operation_mode_transition_manager__msg__OperationModeTransitionManagerDebug__rosidl_typesupport_introspection_c__OperationModeTransitionManagerDebug_init_function,  // function to initialize message memory (memory has to be allocated)
  operation_mode_transition_manager__msg__OperationModeTransitionManagerDebug__rosidl_typesupport_introspection_c__OperationModeTransitionManagerDebug_fini_function  // function to terminate message instance (will not free memory)
};

// this is not const since it must be initialized on first access
// since C does not allow non-integral compile-time constants
static rosidl_message_type_support_t operation_mode_transition_manager__msg__OperationModeTransitionManagerDebug__rosidl_typesupport_introspection_c__OperationModeTransitionManagerDebug_message_type_support_handle = {
  0,
  &operation_mode_transition_manager__msg__OperationModeTransitionManagerDebug__rosidl_typesupport_introspection_c__OperationModeTransitionManagerDebug_message_members,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, operation_mode_transition_manager, msg, OperationModeTransitionManagerDebug)() {
  operation_mode_transition_manager__msg__OperationModeTransitionManagerDebug__rosidl_typesupport_introspection_c__OperationModeTransitionManagerDebug_message_member_array[0].members_ =
    ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, builtin_interfaces, msg, Time)();
  if (!operation_mode_transition_manager__msg__OperationModeTransitionManagerDebug__rosidl_typesupport_introspection_c__OperationModeTransitionManagerDebug_message_type_support_handle.typesupport_identifier) {
    operation_mode_transition_manager__msg__OperationModeTransitionManagerDebug__rosidl_typesupport_introspection_c__OperationModeTransitionManagerDebug_message_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  return &operation_mode_transition_manager__msg__OperationModeTransitionManagerDebug__rosidl_typesupport_introspection_c__OperationModeTransitionManagerDebug_message_type_support_handle;
}
#ifdef __cplusplus
}
#endif
