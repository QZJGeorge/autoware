...
#define NODE_MAIN_LOGGER_NAME "radar_object_tracker"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libradar_object_tracker_node.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<RadarObjectTrackerNode>";
