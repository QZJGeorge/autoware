...
class PredictedObjectKinematics(metaclass=Metaclass_PredictedObjectKinematics):
    ...
    _fields_and_field_types = {
        ...
        'predicted_paths': 'autoware_perception_msgs/PredictedPath[100]',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.Array(rosidl_parser.definition.NamespacedType(['autoware_perception_msgs', 'msg'], 'PredictedPath'), 100),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from autoware_perception_msgs.msg import PredictedPath
        self.predicted_paths = kwargs.get(
            'predicted_paths',
            [PredictedPath() for x in range(100)]
        )
