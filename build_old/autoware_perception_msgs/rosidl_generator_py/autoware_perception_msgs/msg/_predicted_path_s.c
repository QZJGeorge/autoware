...
bool autoware_perception_msgs__msg__predicted_path__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("autoware_perception_msgs.msg._predicted_path.PredictedPath", full_classname_dest, 58) == 0);
  }
  autoware_perception_msgs__msg__PredictedPath * ros_message = _ros_message;
  {  // path
    ...
    Py_ssize_t size = 100;
    geometry_msgs__msg__Pose * dest = ros_message->path;
...
PyObject * autoware_perception_msgs__msg__predicted_path__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("autoware_perception_msgs.msg._predicted_path");
