...
class PredictedPath(metaclass=Metaclass_PredictedPath):
    ...
    _fields_and_field_types = {
        'path': 'geometry_msgs/Pose[100]',
        'time_step': 'builtin_interfaces/Duration',
        'confidence': 'float',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.Array(rosidl_parser.definition.NamespacedType(['geometry_msgs', 'msg'], 'Pose'), 100),  # noqa: E501
