...
autoware_perception_msgs__msg__PredictedPath__init(autoware_perception_msgs__msg__PredictedPath * msg)
{
  ...
  for (size_t i = 0; i < 100; ++i) {
    if (!geometry_msgs__msg__Pose__init(&msg->path[i])) {
...
autoware_perception_msgs__msg__PredictedPath__fini(autoware_perception_msgs__msg__PredictedPath * msg)
{
  ...
  // path
  for (size_t i = 0; i < 100; ++i) {
    geometry_msgs__msg__Pose__fini(&msg->path[i]);
  }
  // time_step
...
bool
autoware_perception_msgs__msg__PredictedPath__are_equal(const autoware_perception_msgs__msg__PredictedPath * lhs, const autoware_perception_msgs__msg__PredictedPath * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
...
bool
autoware_perception_msgs__msg__PredictedPath__copy(
  const autoware_perception_msgs__msg__PredictedPath * input,
  autoware_perception_msgs__msg__PredictedPath * output)
{
  if (!input || !output) {
    return false;
  }
...
autoware_perception_msgs__msg__PredictedPath__create()
{
  ...
  autoware_perception_msgs__msg__PredictedPath * msg = (autoware_perception_msgs__msg__PredictedPath *)allocator.allocate(sizeof(autoware_perception_msgs__msg__PredictedPath), allocator.state);
  if (!msg) {
    return NULL;
  }
...
autoware_perception_msgs__msg__PredictedPath__Sequence__init(autoware_perception_msgs__msg__PredictedPath__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (autoware_perception_msgs__msg__PredictedPath *)allocator.zero_allocate(size, sizeof(autoware_perception_msgs__msg__PredictedPath), allocator.state);
    if (!data) {
      return false;
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  autoware_perception_msgs__msg__PredictedPath__Sequence * array = (autoware_perception_msgs__msg__PredictedPath__Sequence *)allocator.allocate(sizeof(autoware_perception_msgs__msg__PredictedPath__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
...
bool
autoware_perception_msgs__msg__PredictedPath__Sequence__are_equal(const autoware_perception_msgs__msg__PredictedPath__Sequence * lhs, const autoware_perception_msgs__msg__PredictedPath__Sequence * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!autoware_perception_msgs__msg__PredictedPath__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
...
bool
autoware_perception_msgs__msg__PredictedPath__Sequence__copy(
  const autoware_perception_msgs__msg__PredictedPath__Sequence * input,
  autoware_perception_msgs__msg__PredictedPath__Sequence * output)
{
  if (!input || !output) {
    return false;
  }
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(autoware_perception_msgs__msg__PredictedPath);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    autoware_perception_msgs__msg__PredictedPath * data =
      (autoware_perception_msgs__msg__PredictedPath *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!autoware_perception_msgs__msg__PredictedPath__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          autoware_perception_msgs__msg__PredictedPath__fini(&output->data[i]);
        }
        return false;
      }
    }
