...
{
  const auto & member =
    *reinterpret_cast<const std::array<autoware_perception_msgs::msg::PredictedPath, 100> *>(untyped_member);
  return &member[index];
}
...
{
  auto & member =
    *reinterpret_cast<std::array<autoware_perception_msgs::msg::PredictedPath, 100> *>(untyped_member);
  return &member[index];
}
