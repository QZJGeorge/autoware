...
#ifndef AUTOWARE_PERCEPTION_MSGS__MSG__DETAIL__PREDICTED_OBJECT_KINEMATICS__STRUCT_HPP_
#define AUTOWARE_PERCEPTION_MSGS__MSG__DETAIL__PREDICTED_OBJECT_KINEMATICS__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__autoware_perception_msgs__msg__PredictedObjectKinematics __attribute__((deprecated))
#else
# define DEPRECATED__autoware_perception_msgs__msg__PredictedObjectKinematics __declspec(deprecated)
#endif
...
struct PredictedObjectKinematics_
{
    ...
    initial_acceleration_with_covariance(_init)
  {
    ...
    {
      this->predicted_paths.fill(autoware_perception_msgs::msg::PredictedPath_<ContainerAllocator>{_init});
    }
  }
    ...
    predicted_paths(_alloc)
  {
    if (rosidl_runtime_cpp::MessageInitialization::ALL == _init ||
      rosidl_runtime_cpp::MessageInitialization::ZERO == _init)
    {
      this->predicted_paths.fill(autoware_perception_msgs::msg::PredictedPath_<ContainerAllocator>{_alloc, _init});
    }
  }
  ...
  using _predicted_paths_type =
    std::array<autoware_perception_msgs::msg::PredictedPath_<ContainerAllocator>, 100>;
  ...
  Type & set__predicted_paths(
    const std::array<autoware_perception_msgs::msg::PredictedPath_<ContainerAllocator>, 100> & _arg)
  {
  ...
  // pointer types
  using RawPtr =
    autoware_perception_msgs::msg::PredictedObjectKinematics_<ContainerAllocator> *;
  using ConstRawPtr =
    const autoware_perception_msgs::msg::PredictedObjectKinematics_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<autoware_perception_msgs::msg::PredictedObjectKinematics_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<autoware_perception_msgs::msg::PredictedObjectKinematics_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      autoware_perception_msgs::msg::PredictedObjectKinematics_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<autoware_perception_msgs::msg::PredictedObjectKinematics_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<autoware_perception_msgs::msg::PredictedObjectKinematics_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<autoware_perception_msgs::msg::PredictedObjectKinematics_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<autoware_perception_msgs::msg::PredictedObjectKinematics_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__autoware_perception_msgs__msg__PredictedObjectKinematics
    std::shared_ptr<autoware_perception_msgs::msg::PredictedObjectKinematics_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__autoware_perception_msgs__msg__PredictedObjectKinematics
    std::shared_ptr<autoware_perception_msgs::msg::PredictedObjectKinematics_<ContainerAllocator> const>
...
using PredictedObjectKinematics =
  autoware_perception_msgs::msg::PredictedObjectKinematics_<std::allocator<void>>;
...
#endif  // AUTOWARE_PERCEPTION_MSGS__MSG__DETAIL__PREDICTED_OBJECT_KINEMATICS__STRUCT_HPP_
