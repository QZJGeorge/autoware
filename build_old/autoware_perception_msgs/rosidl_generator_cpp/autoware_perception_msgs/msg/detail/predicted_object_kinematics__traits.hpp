...
inline void to_yaml(
  const autoware_perception_msgs::msg::PredictedObjectKinematics & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const autoware_perception_msgs::msg::PredictedObjectKinematics & msg)
{
...
struct has_fixed_size<autoware_perception_msgs::msg::PredictedObjectKinematics>
  : std::integral_constant<bool, has_fixed_size<autoware_perception_msgs::msg::PredictedPath>::value && has_fixed_size<geometry_msgs::msg::AccelWithCovariance>::value && has_fixed_size<geometry_msgs::msg::PoseWithCovariance>::value && has_fixed_size<geometry_msgs::msg::TwistWithCovariance>::value> {};

template<>
struct has_bounded_size<autoware_perception_msgs::msg::PredictedObjectKinematics>
  : std::integral_constant<bool, has_bounded_size<autoware_perception_msgs::msg::PredictedPath>::value && has_bounded_size<geometry_msgs::msg::AccelWithCovariance>::value && has_bounded_size<geometry_msgs::msg::PoseWithCovariance>::value && has_bounded_size<geometry_msgs::msg::TwistWithCovariance>::value> {};
