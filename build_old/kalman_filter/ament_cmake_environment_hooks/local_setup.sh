...
: ${AMENT_CURRENT_PREFIX:="/home/mtl12345/autoware/install/kalman_filter"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/kalman_filter/environment/library_path.sh"
