...
#define NODE_MAIN_LOGGER_NAME "control_validator_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libcontrol_validator_component.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<control_validator::ControlValidator>";
