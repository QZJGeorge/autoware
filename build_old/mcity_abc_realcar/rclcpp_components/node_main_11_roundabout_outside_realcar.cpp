...
#define NODE_MAIN_LOGGER_NAME "11_roundabout_outside_realcar"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libtest_11_realcar_component.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<test_11_realcar::Test11Realcar>";
