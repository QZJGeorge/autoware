...
#define NODE_MAIN_LOGGER_NAME "06_left_turn_turn_realcar"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libtest_06_realcar_component.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<test_06_realcar::Test06Realcar>";
