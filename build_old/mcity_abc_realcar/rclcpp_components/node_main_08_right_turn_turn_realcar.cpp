...
#define NODE_MAIN_LOGGER_NAME "08_right_turn_turn_realcar"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libtest_08_realcar_component.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<test_08_realcar::Test08Realcar>";
