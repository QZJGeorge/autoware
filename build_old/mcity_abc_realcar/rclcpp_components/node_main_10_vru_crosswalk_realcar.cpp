...
#define NODE_MAIN_LOGGER_NAME "10_vru_crosswalk_realcar"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libtest_10_realcar_component.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<test_10_realcar::Test10Realcar>";
