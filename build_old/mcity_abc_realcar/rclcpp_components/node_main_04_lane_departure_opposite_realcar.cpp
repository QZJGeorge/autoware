...
#define NODE_MAIN_LOGGER_NAME "04_lane_departure_opposite_realcar"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libtest_04_realcar_component.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<test_04_realcar::Test04Realcar>";
