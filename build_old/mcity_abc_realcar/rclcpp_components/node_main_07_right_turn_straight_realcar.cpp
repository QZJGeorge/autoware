...
#define NODE_MAIN_LOGGER_NAME "07_right_turn_straight_realcar"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libtest_07_realcar_component.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<test_07_realcar::Test07Realcar>";
