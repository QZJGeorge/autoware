...
#define NODE_MAIN_LOGGER_NAME "05_left_turn_straight_realcar"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libtest_05_realcar_component.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<test_05_realcar::Test05Realcar>";
