...
#define NODE_MAIN_LOGGER_NAME "02_car_following_realcar"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libtest_02_realcar_component.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<test_02_realcar::Test02Realcar>";
