...
#define NODE_MAIN_LOGGER_NAME "12_roundabout_inside_realcar"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libtest_12_realcar_component.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<test_12_realcar::Test12Realcar>";
