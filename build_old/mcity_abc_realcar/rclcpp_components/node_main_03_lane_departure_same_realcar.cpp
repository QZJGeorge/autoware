...
#define NODE_MAIN_LOGGER_NAME "03_lane_departure_same_realcar"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libtest_03_realcar_component.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<test_03_realcar::Test03Realcar>";
