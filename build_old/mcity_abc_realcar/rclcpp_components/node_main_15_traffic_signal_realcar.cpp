...
#define NODE_MAIN_LOGGER_NAME "15_traffic_signal_realcar"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libtest_15_realcar_component.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<test_15_realcar::Test15Realcar>";
