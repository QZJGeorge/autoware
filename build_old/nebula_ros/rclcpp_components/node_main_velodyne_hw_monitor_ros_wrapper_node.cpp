...
#define NODE_MAIN_LOGGER_NAME "velodyne_hw_monitor_ros_wrapper_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libvelodyne_hw_monitor_ros_wrapper.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<VelodyneHwMonitorRosWrapper>";
