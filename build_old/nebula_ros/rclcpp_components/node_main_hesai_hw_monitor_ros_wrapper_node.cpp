...
#define NODE_MAIN_LOGGER_NAME "hesai_hw_monitor_ros_wrapper_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libhesai_hw_monitor_ros_wrapper.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<HesaiHwMonitorRosWrapper>";
