...
#define NODE_MAIN_LOGGER_NAME "velodyne_driver_ros_wrapper_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libvelodyne_driver_ros_wrapper.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<VelodyneDriverRosWrapper>";
