...
#define NODE_MAIN_LOGGER_NAME "lidar_apollo_instance_segmentation_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "liblidar_apollo_instance_segmentation.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<lidar_apollo_instance_segmentation::LidarInstanceSegmentationNode>";
