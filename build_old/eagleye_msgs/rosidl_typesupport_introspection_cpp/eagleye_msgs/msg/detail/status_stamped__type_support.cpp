...
{
  new (message_memory) eagleye_msgs::msg::StatusStamped(_init);
}

void StatusStamped_fini_function(void * message_memory)
{
  auto typed_message = static_cast<eagleye_msgs::msg::StatusStamped *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember StatusStamped_message_member_array[2] = {
  {
    ...
    offsetof(eagleye_msgs::msg::StatusStamped, header),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(eagleye_msgs::msg::StatusStamped, status),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers StatusStamped_message_members = {
  ...
  2,  // number of fields
  sizeof(eagleye_msgs::msg::StatusStamped),
...
get_message_type_support_handle<eagleye_msgs::msg::StatusStamped>()
{
  return &::eagleye_msgs::msg::rosidl_typesupport_introspection_cpp::StatusStamped_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, eagleye_msgs, msg, StatusStamped)() {
  return &::eagleye_msgs::msg::rosidl_typesupport_introspection_cpp::StatusStamped_message_type_support_handle;
}
