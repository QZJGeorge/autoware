...
{
  new (message_memory) eagleye_msgs::msg::Status(_init);
}

void Status_fini_function(void * message_memory)
{
  auto typed_message = static_cast<eagleye_msgs::msg::Status *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Status_message_member_array[4] = {
  {
    ...
    offsetof(eagleye_msgs::msg::Status, enabled_status),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(eagleye_msgs::msg::Status, estimate_status),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(eagleye_msgs::msg::Status, is_abnormal),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(eagleye_msgs::msg::Status, error_code),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Status_message_members = {
  ...
  "Status",  // message name
  4,  // number of fields
  sizeof(eagleye_msgs::msg::Status),
...
get_message_type_support_handle<eagleye_msgs::msg::Status>()
{
  return &::eagleye_msgs::msg::rosidl_typesupport_introspection_cpp::Status_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, eagleye_msgs, msg, Status)() {
  return &::eagleye_msgs::msg::rosidl_typesupport_introspection_cpp::Status_message_type_support_handle;
}
