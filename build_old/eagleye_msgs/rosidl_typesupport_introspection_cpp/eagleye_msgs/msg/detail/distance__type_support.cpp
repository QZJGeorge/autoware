...
{
  new (message_memory) eagleye_msgs::msg::Distance(_init);
}

void Distance_fini_function(void * message_memory)
{
  auto typed_message = static_cast<eagleye_msgs::msg::Distance *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Distance_message_member_array[3] = {
  {
    ...
    offsetof(eagleye_msgs::msg::Distance, header),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(eagleye_msgs::msg::Distance, distance),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(eagleye_msgs::msg::Distance, status),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Distance_message_members = {
  ...
  3,  // number of fields
  sizeof(eagleye_msgs::msg::Distance),
...
get_message_type_support_handle<eagleye_msgs::msg::Distance>()
{
  return &::eagleye_msgs::msg::rosidl_typesupport_introspection_cpp::Distance_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, eagleye_msgs, msg, Distance)() {
  return &::eagleye_msgs::msg::rosidl_typesupport_introspection_cpp::Distance_message_type_support_handle;
}
