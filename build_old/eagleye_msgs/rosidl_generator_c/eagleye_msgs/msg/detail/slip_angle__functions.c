...
eagleye_msgs__msg__SlipAngle__init(eagleye_msgs__msg__SlipAngle * msg)
{
  ...
  if (!std_msgs__msg__Header__init(&msg->header)) {
    eagleye_msgs__msg__SlipAngle__fini(msg);
    return false;
  }
  // coefficient
  // slip_angle
...
eagleye_msgs__msg__SlipAngle__create()
{
  ...
  eagleye_msgs__msg__SlipAngle * msg = (eagleye_msgs__msg__SlipAngle *)allocator.allocate(sizeof(eagleye_msgs__msg__SlipAngle), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(eagleye_msgs__msg__SlipAngle));
  bool success = eagleye_msgs__msg__SlipAngle__init(msg);
  if (!success) {
...
eagleye_msgs__msg__SlipAngle__Sequence__init(eagleye_msgs__msg__SlipAngle__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  eagleye_msgs__msg__SlipAngle * data = NULL;

  if (size) {
    data = (eagleye_msgs__msg__SlipAngle *)allocator.zero_allocate(size, sizeof(eagleye_msgs__msg__SlipAngle), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = eagleye_msgs__msg__SlipAngle__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        eagleye_msgs__msg__SlipAngle__fini(&data[i - 1]);
      }
...
eagleye_msgs__msg__SlipAngle__Sequence__fini(eagleye_msgs__msg__SlipAngle__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      eagleye_msgs__msg__SlipAngle__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  eagleye_msgs__msg__SlipAngle__Sequence * array = (eagleye_msgs__msg__SlipAngle__Sequence *)allocator.allocate(sizeof(eagleye_msgs__msg__SlipAngle__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = eagleye_msgs__msg__SlipAngle__Sequence__init(array, size);
  if (!success) {
...
eagleye_msgs__msg__SlipAngle__Sequence__destroy(eagleye_msgs__msg__SlipAngle__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    eagleye_msgs__msg__SlipAngle__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
eagleye_msgs__msg__SlipAngle__Sequence__are_equal(const eagleye_msgs__msg__SlipAngle__Sequence * lhs, const eagleye_msgs__msg__SlipAngle__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!eagleye_msgs__msg__SlipAngle__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  eagleye_msgs__msg__SlipAngle__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(eagleye_msgs__msg__SlipAngle);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    eagleye_msgs__msg__SlipAngle * data =
      (eagleye_msgs__msg__SlipAngle *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!eagleye_msgs__msg__SlipAngle__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          eagleye_msgs__msg__SlipAngle__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!eagleye_msgs__msg__SlipAngle__copy(
