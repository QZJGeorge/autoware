...
eagleye_msgs__msg__AngularVelocityOffset__init(eagleye_msgs__msg__AngularVelocityOffset * msg)
{
  ...
  if (!std_msgs__msg__Header__init(&msg->header)) {
    eagleye_msgs__msg__AngularVelocityOffset__fini(msg);
    return false;
  }
  // angular_velocity_offset
  if (!geometry_msgs__msg__Vector3__init(&msg->angular_velocity_offset)) {
    eagleye_msgs__msg__AngularVelocityOffset__fini(msg);
    return false;
  }
  // status
...
eagleye_msgs__msg__AngularVelocityOffset__fini(eagleye_msgs__msg__AngularVelocityOffset * msg)
{
  ...
  // angular_velocity_offset
  geometry_msgs__msg__Vector3__fini(&msg->angular_velocity_offset);
  // status
...
eagleye_msgs__msg__AngularVelocityOffset__are_equal(const eagleye_msgs__msg__AngularVelocityOffset * lhs, const eagleye_msgs__msg__AngularVelocityOffset * rhs)
{
  ...
  if (!geometry_msgs__msg__Vector3__are_equal(
      &(lhs->angular_velocity_offset), &(rhs->angular_velocity_offset)))
  {
    return false;
  }
  // status
  ...
  eagleye_msgs__msg__AngularVelocityOffset * output)
{
  ...
  if (!geometry_msgs__msg__Vector3__copy(
      &(input->angular_velocity_offset), &(output->angular_velocity_offset)))
  {
    return false;
  }
  // status
...
eagleye_msgs__msg__AngularVelocityOffset__create()
{
  ...
  eagleye_msgs__msg__AngularVelocityOffset * msg = (eagleye_msgs__msg__AngularVelocityOffset *)allocator.allocate(sizeof(eagleye_msgs__msg__AngularVelocityOffset), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(eagleye_msgs__msg__AngularVelocityOffset));
  bool success = eagleye_msgs__msg__AngularVelocityOffset__init(msg);
  if (!success) {
...
eagleye_msgs__msg__AngularVelocityOffset__Sequence__init(eagleye_msgs__msg__AngularVelocityOffset__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  eagleye_msgs__msg__AngularVelocityOffset * data = NULL;

  if (size) {
    data = (eagleye_msgs__msg__AngularVelocityOffset *)allocator.zero_allocate(size, sizeof(eagleye_msgs__msg__AngularVelocityOffset), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = eagleye_msgs__msg__AngularVelocityOffset__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        eagleye_msgs__msg__AngularVelocityOffset__fini(&data[i - 1]);
      }
...
eagleye_msgs__msg__AngularVelocityOffset__Sequence__fini(eagleye_msgs__msg__AngularVelocityOffset__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      eagleye_msgs__msg__AngularVelocityOffset__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  eagleye_msgs__msg__AngularVelocityOffset__Sequence * array = (eagleye_msgs__msg__AngularVelocityOffset__Sequence *)allocator.allocate(sizeof(eagleye_msgs__msg__AngularVelocityOffset__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = eagleye_msgs__msg__AngularVelocityOffset__Sequence__init(array, size);
  if (!success) {
...
eagleye_msgs__msg__AngularVelocityOffset__Sequence__destroy(eagleye_msgs__msg__AngularVelocityOffset__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    eagleye_msgs__msg__AngularVelocityOffset__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
eagleye_msgs__msg__AngularVelocityOffset__Sequence__are_equal(const eagleye_msgs__msg__AngularVelocityOffset__Sequence * lhs, const eagleye_msgs__msg__AngularVelocityOffset__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!eagleye_msgs__msg__AngularVelocityOffset__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  eagleye_msgs__msg__AngularVelocityOffset__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(eagleye_msgs__msg__AngularVelocityOffset);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    eagleye_msgs__msg__AngularVelocityOffset * data =
      (eagleye_msgs__msg__AngularVelocityOffset *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!eagleye_msgs__msg__AngularVelocityOffset__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          eagleye_msgs__msg__AngularVelocityOffset__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!eagleye_msgs__msg__AngularVelocityOffset__copy(
