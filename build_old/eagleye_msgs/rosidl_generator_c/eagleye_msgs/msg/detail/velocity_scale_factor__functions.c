...
eagleye_msgs__msg__VelocityScaleFactor__init(eagleye_msgs__msg__VelocityScaleFactor * msg)
{
  ...
  if (!std_msgs__msg__Header__init(&msg->header)) {
    eagleye_msgs__msg__VelocityScaleFactor__fini(msg);
    return false;
  }
  // scale_factor
  // status
...
eagleye_msgs__msg__VelocityScaleFactor__create()
{
  ...
  eagleye_msgs__msg__VelocityScaleFactor * msg = (eagleye_msgs__msg__VelocityScaleFactor *)allocator.allocate(sizeof(eagleye_msgs__msg__VelocityScaleFactor), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(eagleye_msgs__msg__VelocityScaleFactor));
  bool success = eagleye_msgs__msg__VelocityScaleFactor__init(msg);
  if (!success) {
...
eagleye_msgs__msg__VelocityScaleFactor__Sequence__init(eagleye_msgs__msg__VelocityScaleFactor__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  eagleye_msgs__msg__VelocityScaleFactor * data = NULL;

  if (size) {
    data = (eagleye_msgs__msg__VelocityScaleFactor *)allocator.zero_allocate(size, sizeof(eagleye_msgs__msg__VelocityScaleFactor), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = eagleye_msgs__msg__VelocityScaleFactor__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        eagleye_msgs__msg__VelocityScaleFactor__fini(&data[i - 1]);
      }
...
eagleye_msgs__msg__VelocityScaleFactor__Sequence__fini(eagleye_msgs__msg__VelocityScaleFactor__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      eagleye_msgs__msg__VelocityScaleFactor__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  eagleye_msgs__msg__VelocityScaleFactor__Sequence * array = (eagleye_msgs__msg__VelocityScaleFactor__Sequence *)allocator.allocate(sizeof(eagleye_msgs__msg__VelocityScaleFactor__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = eagleye_msgs__msg__VelocityScaleFactor__Sequence__init(array, size);
  if (!success) {
...
eagleye_msgs__msg__VelocityScaleFactor__Sequence__destroy(eagleye_msgs__msg__VelocityScaleFactor__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    eagleye_msgs__msg__VelocityScaleFactor__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
eagleye_msgs__msg__VelocityScaleFactor__Sequence__are_equal(const eagleye_msgs__msg__VelocityScaleFactor__Sequence * lhs, const eagleye_msgs__msg__VelocityScaleFactor__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!eagleye_msgs__msg__VelocityScaleFactor__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  eagleye_msgs__msg__VelocityScaleFactor__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(eagleye_msgs__msg__VelocityScaleFactor);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    eagleye_msgs__msg__VelocityScaleFactor * data =
      (eagleye_msgs__msg__VelocityScaleFactor *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!eagleye_msgs__msg__VelocityScaleFactor__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          eagleye_msgs__msg__VelocityScaleFactor__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!eagleye_msgs__msg__VelocityScaleFactor__copy(
