...
eagleye_msgs__msg__Pitching__init(eagleye_msgs__msg__Pitching * msg)
{
  ...
  if (!std_msgs__msg__Header__init(&msg->header)) {
    eagleye_msgs__msg__Pitching__fini(msg);
    return false;
  }
  // pitching_angle
  // status
...
eagleye_msgs__msg__Pitching__are_equal(const eagleye_msgs__msg__Pitching * lhs, const eagleye_msgs__msg__Pitching * rhs)
{
  ...
  // pitching_angle
  if (lhs->pitching_angle != rhs->pitching_angle) {
    return false;
  }
  // status
  ...
  eagleye_msgs__msg__Pitching * output)
{
  ...
  // pitching_angle
  output->pitching_angle = input->pitching_angle;
  // status
...
eagleye_msgs__msg__Pitching__create()
{
  ...
  eagleye_msgs__msg__Pitching * msg = (eagleye_msgs__msg__Pitching *)allocator.allocate(sizeof(eagleye_msgs__msg__Pitching), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(eagleye_msgs__msg__Pitching));
  bool success = eagleye_msgs__msg__Pitching__init(msg);
  if (!success) {
...
eagleye_msgs__msg__Pitching__Sequence__init(eagleye_msgs__msg__Pitching__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  eagleye_msgs__msg__Pitching * data = NULL;

  if (size) {
    data = (eagleye_msgs__msg__Pitching *)allocator.zero_allocate(size, sizeof(eagleye_msgs__msg__Pitching), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = eagleye_msgs__msg__Pitching__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        eagleye_msgs__msg__Pitching__fini(&data[i - 1]);
      }
...
eagleye_msgs__msg__Pitching__Sequence__fini(eagleye_msgs__msg__Pitching__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      eagleye_msgs__msg__Pitching__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  eagleye_msgs__msg__Pitching__Sequence * array = (eagleye_msgs__msg__Pitching__Sequence *)allocator.allocate(sizeof(eagleye_msgs__msg__Pitching__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = eagleye_msgs__msg__Pitching__Sequence__init(array, size);
  if (!success) {
...
eagleye_msgs__msg__Pitching__Sequence__destroy(eagleye_msgs__msg__Pitching__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    eagleye_msgs__msg__Pitching__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
eagleye_msgs__msg__Pitching__Sequence__are_equal(const eagleye_msgs__msg__Pitching__Sequence * lhs, const eagleye_msgs__msg__Pitching__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!eagleye_msgs__msg__Pitching__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  eagleye_msgs__msg__Pitching__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(eagleye_msgs__msg__Pitching);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    eagleye_msgs__msg__Pitching * data =
      (eagleye_msgs__msg__Pitching *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!eagleye_msgs__msg__Pitching__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          eagleye_msgs__msg__Pitching__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!eagleye_msgs__msg__Pitching__copy(
