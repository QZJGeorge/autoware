...
#ifndef EAGLEYE_MSGS__MSG__DETAIL__HEIGHT__TRAITS_HPP_
#define EAGLEYE_MSGS__MSG__DETAIL__HEIGHT__TRAITS_HPP_
...
inline std::string to_yaml(const Height & msg, bool use_flow_style = false)
{
...
inline void to_yaml(
  const eagleye_msgs::msg::Height & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const eagleye_msgs::msg::Height & msg)
{
  return eagleye_msgs::msg::to_yaml(msg);
}

template<>
inline const char * data_type<eagleye_msgs::msg::Height>()
{
  return "eagleye_msgs::msg::Height";
}

template<>
inline const char * name<eagleye_msgs::msg::Height>()
{
  return "eagleye_msgs/msg/Height";
}

template<>
struct has_fixed_size<eagleye_msgs::msg::Height>
  : std::integral_constant<bool, has_fixed_size<eagleye_msgs::msg::Status>::value && has_fixed_size<std_msgs::msg::Header>::value> {};

template<>
struct has_bounded_size<eagleye_msgs::msg::Height>
  : std::integral_constant<bool, has_bounded_size<eagleye_msgs::msg::Status>::value && has_bounded_size<std_msgs::msg::Header>::value> {};

template<>
struct is_message<eagleye_msgs::msg::Height>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // EAGLEYE_MSGS__MSG__DETAIL__HEIGHT__TRAITS_HPP_
