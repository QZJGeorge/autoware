...
#include "eagleye_msgs/msg/detail/distance__rosidl_typesupport_fastrtps_c.h"
...
using _Distance__ros_msg_type = eagleye_msgs__msg__Distance;
...
size_t get_serialized_size_eagleye_msgs__msg__Distance(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Distance__ros_msg_type * ros_message = static_cast<const _Distance__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _Distance__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_eagleye_msgs__msg__Distance(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_eagleye_msgs
size_t max_serialized_size_eagleye_msgs__msg__Distance(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = eagleye_msgs__msg__Distance;
    is_plain =
      (
...
static size_t _Distance__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_eagleye_msgs__msg__Distance(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, eagleye_msgs, msg, Distance)() {
