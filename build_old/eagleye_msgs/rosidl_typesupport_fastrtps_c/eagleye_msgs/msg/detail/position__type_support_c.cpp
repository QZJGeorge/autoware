...
#include "eagleye_msgs/msg/detail/position__rosidl_typesupport_fastrtps_c.h"
...
#include "geometry_msgs/msg/detail/point__functions.h"  // ecef_base_pos, enu_pos
...
using _Position__ros_msg_type = eagleye_msgs__msg__Position;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: enu_pos
  {
    ...
    if (!callbacks->cdr_serialize(
        &ros_message->enu_pos, cdr))
    {
      return false;
    }
  }

  // Field name: ecef_base_pos
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
      ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(
...
size_t get_serialized_size_eagleye_msgs__msg__Position(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Position__ros_msg_type * ros_message = static_cast<const _Position__ros_msg_type *>(untyped_ros_message);
  ...
  current_alignment += get_serialized_size_geometry_msgs__msg__Point(
    &(ros_message->enu_pos), current_alignment);
  // field.name ecef_base_pos

  current_alignment += get_serialized_size_geometry_msgs__msg__Point(
    &(ros_message->ecef_base_pos), current_alignment);
  // field.name covariance
  {
    size_t array_size = 9;
    auto array_ptr = ros_message->covariance;
...
static uint32_t _Position__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_eagleye_msgs__msg__Position(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_eagleye_msgs
size_t max_serialized_size_eagleye_msgs__msg__Position(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = eagleye_msgs__msg__Position;
    is_plain =
      (
...
static size_t _Position__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_eagleye_msgs__msg__Position(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, eagleye_msgs, msg, Position)() {
