...
static const _YawrateOffset_type_support_symbol_names_t _YawrateOffset_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, eagleye_msgs, msg, YawrateOffset)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, eagleye_msgs, msg, YawrateOffset)),
  }
};
...
{
  return &::eagleye_msgs::msg::rosidl_typesupport_cpp::YawrateOffset_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, eagleye_msgs, msg, YawrateOffset)() {
  return get_message_type_support_handle<eagleye_msgs::msg::YawrateOffset>();
}
