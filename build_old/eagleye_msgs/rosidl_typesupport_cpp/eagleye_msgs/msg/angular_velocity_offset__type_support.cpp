...
static const _AngularVelocityOffset_type_support_symbol_names_t _AngularVelocityOffset_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, eagleye_msgs, msg, AngularVelocityOffset)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, eagleye_msgs, msg, AngularVelocityOffset)),
  }
};
...
{
  return &::eagleye_msgs::msg::rosidl_typesupport_cpp::AngularVelocityOffset_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, eagleye_msgs, msg, AngularVelocityOffset)() {
  return get_message_type_support_handle<eagleye_msgs::msg::AngularVelocityOffset>();
}
