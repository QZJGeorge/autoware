...
static const _StatusStamped_type_support_symbol_names_t _StatusStamped_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, eagleye_msgs, msg, StatusStamped)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, eagleye_msgs, msg, StatusStamped)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, eagleye_msgs, msg, StatusStamped)() {
  return &::eagleye_msgs::msg::rosidl_typesupport_c::StatusStamped_message_type_support_handle;
}
