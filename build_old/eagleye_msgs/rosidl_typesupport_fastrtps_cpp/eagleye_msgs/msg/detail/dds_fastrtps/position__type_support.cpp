...
#include "eagleye_msgs/msg/detail/position__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const eagleye_msgs::msg::Position & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  eagleye_msgs::msg::Position & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = eagleye_msgs::msg::Position;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const eagleye_msgs::msg::Position *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<eagleye_msgs::msg::Position *>(
    untyped_ros_message);
...
{
  return &eagleye_msgs::msg::typesupport_fastrtps_cpp::_Position__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, eagleye_msgs, msg, Position)() {
  return &eagleye_msgs::msg::typesupport_fastrtps_cpp::_Position__handle;
}
