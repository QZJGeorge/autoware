...
#include "eagleye_msgs/msg/detail/slip_angle__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = eagleye_msgs::msg::SlipAngle;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const eagleye_msgs::msg::SlipAngle *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<eagleye_msgs::msg::SlipAngle *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _SlipAngle__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const eagleye_msgs::msg::SlipAngle *>(
...
static size_t _SlipAngle__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_SlipAngle(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _SlipAngle__callbacks = {
  "eagleye_msgs::msg",
  "SlipAngle",
...
static rosidl_message_type_support_t _SlipAngle__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_SlipAngle__callbacks,
...
{
  return &eagleye_msgs::msg::typesupport_fastrtps_cpp::_SlipAngle__handle;
}
