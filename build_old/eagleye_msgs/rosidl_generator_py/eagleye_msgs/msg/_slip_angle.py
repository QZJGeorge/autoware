...
class Metaclass_SlipAngle(type):
    """Metaclass of message 'SlipAngle'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__slip_angle
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__slip_angle
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__slip_angle
            cls._TYPE_SUPPORT = module.type_support_msg__msg__slip_angle
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__slip_angle
...
class SlipAngle(metaclass=Metaclass_SlipAngle):
    """Message class 'SlipAngle'."""
    ...
    def __init__(self, **kwargs):
        ...
        self.coefficient = kwargs.get('coefficient', float())
    ...
    def coefficient(self, value):
        if __debug__:
            assert \
                ...
                "The 'coefficient' field must be of type 'float'"
            assert not (value < -1.7976931348623157e+308 or value > 1.7976931348623157e+308) or math.isinf(value), \
                "The 'coefficient' field must be a double in [-1.7976931348623157e+308, 1.7976931348623157e+308]"
