...
bool eagleye_msgs__msg__heading__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("eagleye_msgs.msg._heading.Heading", full_classname_dest, 33) == 0);
  }
  eagleye_msgs__msg__Heading * ros_message = _ros_message;
  {  // header
...
PyObject * eagleye_msgs__msg__heading__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("eagleye_msgs.msg._heading");
