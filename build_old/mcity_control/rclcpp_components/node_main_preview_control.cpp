...
#define NODE_MAIN_LOGGER_NAME "preview_control"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libpreview_control_component.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<preview_control::PreviewControl>";
