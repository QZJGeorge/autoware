  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = tier4_localization_msgs__srv__PoseWithCovarianceStamped_Request;
    is_plain =
      (
      offsetof(DataType, pose_with_covariance) +
      last_member_size
      ) == ret_val;
  }
...
static size_t _PoseWithCovarianceStamped_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_tier4_localization_msgs__srv__PoseWithCovarianceStamped_Request(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = tier4_localization_msgs__srv__PoseWithCovarianceStamped_Response;
    is_plain =
      (
      offsetof(DataType, pose_with_covariance) +
      last_member_size
...
static size_t _PoseWithCovarianceStamped_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_tier4_localization_msgs__srv__PoseWithCovarianceStamped_Response(
    full_bounded, is_plain, 0);
