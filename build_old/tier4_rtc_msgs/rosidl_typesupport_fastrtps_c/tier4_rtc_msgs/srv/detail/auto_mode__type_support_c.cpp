  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = tier4_rtc_msgs__srv__AutoMode_Request;
    is_plain =
      (
...
static size_t _AutoMode_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_tier4_rtc_msgs__srv__AutoMode_Request(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = tier4_rtc_msgs__srv__AutoMode_Response;
    is_plain =
      (
...
static size_t _AutoMode_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_tier4_rtc_msgs__srv__AutoMode_Response(
    full_bounded, is_plain, 0);
