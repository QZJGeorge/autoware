...
#include "tier4_rtc_msgs/msg/detail/command__rosidl_typesupport_fastrtps_c.h"
...
using _Command__ros_msg_type = tier4_rtc_msgs__msg__Command;
...
static uint32_t _Command__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_tier4_rtc_msgs__msg__Command(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = tier4_rtc_msgs__msg__Command;
    is_plain =
      (
...
static size_t _Command__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_tier4_rtc_msgs__msg__Command(
