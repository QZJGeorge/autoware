...
#include "tier4_rtc_msgs/msg/detail/cooperate_status__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const tier4_rtc_msgs::msg::CooperateStatus & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  tier4_rtc_msgs::msg::CooperateStatus & ros_message)
{
  // Member: stamp
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = tier4_rtc_msgs::msg::CooperateStatus;
    is_plain =
      (
      offsetof(DataType, finish_distance) +
      last_member_size
      ) == ret_val;
  }
...
{
  auto typed_message =
    static_cast<const tier4_rtc_msgs::msg::CooperateStatus *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<tier4_rtc_msgs::msg::CooperateStatus *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _CooperateStatus__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const tier4_rtc_msgs::msg::CooperateStatus *>(
...
static size_t _CooperateStatus__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_CooperateStatus(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _CooperateStatus__callbacks = {
  "tier4_rtc_msgs::msg",
  "CooperateStatus",
...
static rosidl_message_type_support_t _CooperateStatus__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_CooperateStatus__callbacks,
...
get_message_type_support_handle<tier4_rtc_msgs::msg::CooperateStatus>()
{
  return &tier4_rtc_msgs::msg::typesupport_fastrtps_cpp::_CooperateStatus__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, tier4_rtc_msgs, msg, CooperateStatus)() {
  return &tier4_rtc_msgs::msg::typesupport_fastrtps_cpp::_CooperateStatus__handle;
}
