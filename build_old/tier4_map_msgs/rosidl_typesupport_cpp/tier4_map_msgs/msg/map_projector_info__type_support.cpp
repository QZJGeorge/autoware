...
static const _MapProjectorInfo_type_support_symbol_names_t _MapProjectorInfo_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, tier4_map_msgs, msg, MapProjectorInfo)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, tier4_map_msgs, msg, MapProjectorInfo)),
  }
};
...
{
  return &::tier4_map_msgs::msg::rosidl_typesupport_cpp::MapProjectorInfo_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, tier4_map_msgs, msg, MapProjectorInfo)() {
  return get_message_type_support_handle<tier4_map_msgs::msg::MapProjectorInfo>();
}
