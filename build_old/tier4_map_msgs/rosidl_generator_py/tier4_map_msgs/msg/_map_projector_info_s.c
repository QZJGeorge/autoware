...
bool tier4_map_msgs__msg__map_projector_info__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("tier4_map_msgs.msg._map_projector_info.MapProjectorInfo", full_classname_dest, 55) == 0);
  }
  tier4_map_msgs__msg__MapProjectorInfo * ros_message = _ros_message;
  {  // projector_type
...
PyObject * tier4_map_msgs__msg__map_projector_info__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("tier4_map_msgs.msg._map_projector_info");
