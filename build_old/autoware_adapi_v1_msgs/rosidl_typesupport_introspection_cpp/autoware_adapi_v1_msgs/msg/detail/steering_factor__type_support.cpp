...
size_t size_function__SteeringFactor__cooperation(const void * untyped_member)
{
  const auto * member = reinterpret_cast<const std::vector<autoware_adapi_v1_msgs::msg::CooperationStatus> *>(untyped_member);
  return member->size();
}

const void * get_const_function__SteeringFactor__cooperation(const void * untyped_member, size_t index)
{
  const auto & member =
...
void * get_function__SteeringFactor__cooperation(void * untyped_member, size_t index)
{
  auto & member =
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember SteeringFactor_message_member_array[9] = {
  {
    "pose",  // name
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(autoware_adapi_v1_msgs::msg::SteeringFactor, behavior),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(autoware_adapi_v1_msgs::msg::SteeringFactor, sequence),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    1,  // array size
    true,  // is upper bound
    offsetof(autoware_adapi_v1_msgs::msg::SteeringFactor, cooperation),  // bytes offset in struct
    nullptr,  // default value
    size_function__SteeringFactor__cooperation,  // size() function pointer
    get_const_function__SteeringFactor__cooperation,  // get_const(index) function pointer
    get_function__SteeringFactor__cooperation,  // get(index) function pointer
    fetch_function__SteeringFactor__cooperation,  // fetch(index, &value) function pointer
    assign_function__SteeringFactor__cooperation,  // assign(index, value) function pointer
    resize_function__SteeringFactor__cooperation  // resize(index) function pointer
  },
  {
    "type",  // name
    ::rosidl_typesupport_introspection_cpp::ROS_TYPE_UINT16,  // type
