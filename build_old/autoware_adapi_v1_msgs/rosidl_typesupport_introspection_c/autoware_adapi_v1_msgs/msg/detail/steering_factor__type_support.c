...
size_t autoware_adapi_v1_msgs__msg__SteeringFactor__rosidl_typesupport_introspection_c__size_function__SteeringFactor__cooperation(
  const void * untyped_member)
{
...
const void * autoware_adapi_v1_msgs__msg__SteeringFactor__rosidl_typesupport_introspection_c__get_const_function__SteeringFactor__cooperation(
  const void * untyped_member, size_t index)
{
  const autoware_adapi_v1_msgs__msg__CooperationStatus__Sequence * member =
    (const autoware_adapi_v1_msgs__msg__CooperationStatus__Sequence *)(untyped_member);
...
void * autoware_adapi_v1_msgs__msg__SteeringFactor__rosidl_typesupport_introspection_c__get_function__SteeringFactor__cooperation(
  void * untyped_member, size_t index)
{
...
void autoware_adapi_v1_msgs__msg__SteeringFactor__rosidl_typesupport_introspection_c__fetch_function__SteeringFactor__cooperation(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const autoware_adapi_v1_msgs__msg__CooperationStatus * item =
    ((const autoware_adapi_v1_msgs__msg__CooperationStatus *)
    autoware_adapi_v1_msgs__msg__SteeringFactor__rosidl_typesupport_introspection_c__get_const_function__SteeringFactor__cooperation(untyped_member, index));
  autoware_adapi_v1_msgs__msg__CooperationStatus * value =
    (autoware_adapi_v1_msgs__msg__CooperationStatus *)(untyped_value);
  *value = *item;
}

void autoware_adapi_v1_msgs__msg__SteeringFactor__rosidl_typesupport_introspection_c__assign_function__SteeringFactor__cooperation(
  void * untyped_member, size_t index, const void * untyped_value)
{
  autoware_adapi_v1_msgs__msg__CooperationStatus * item =
    ((autoware_adapi_v1_msgs__msg__CooperationStatus *)
    autoware_adapi_v1_msgs__msg__SteeringFactor__rosidl_typesupport_introspection_c__get_function__SteeringFactor__cooperation(untyped_member, index));
  const autoware_adapi_v1_msgs__msg__CooperationStatus * value =
    (const autoware_adapi_v1_msgs__msg__CooperationStatus *)(untyped_value);
  *item = *value;
}

bool autoware_adapi_v1_msgs__msg__SteeringFactor__rosidl_typesupport_introspection_c__resize_function__SteeringFactor__cooperation(
...
static rosidl_typesupport_introspection_c__MessageMember autoware_adapi_v1_msgs__msg__SteeringFactor__rosidl_typesupport_introspection_c__SteeringFactor_message_member_array[9] = {
  {
    "pose",  // name
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(autoware_adapi_v1_msgs__msg__SteeringFactor, behavior),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(autoware_adapi_v1_msgs__msg__SteeringFactor, sequence),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    1,  // array size
    true,  // is upper bound
    offsetof(autoware_adapi_v1_msgs__msg__SteeringFactor, cooperation),  // bytes offset in struct
    NULL,  // default value
    autoware_adapi_v1_msgs__msg__SteeringFactor__rosidl_typesupport_introspection_c__size_function__SteeringFactor__cooperation,  // size() function pointer
    autoware_adapi_v1_msgs__msg__SteeringFactor__rosidl_typesupport_introspection_c__get_const_function__SteeringFactor__cooperation,  // get_const(index) function pointer
    autoware_adapi_v1_msgs__msg__SteeringFactor__rosidl_typesupport_introspection_c__get_function__SteeringFactor__cooperation,  // get(index) function pointer
    autoware_adapi_v1_msgs__msg__SteeringFactor__rosidl_typesupport_introspection_c__fetch_function__SteeringFactor__cooperation,  // fetch(index, &value) function pointer
    autoware_adapi_v1_msgs__msg__SteeringFactor__rosidl_typesupport_introspection_c__assign_function__SteeringFactor__cooperation,  // assign(index, value) function pointer
    autoware_adapi_v1_msgs__msg__SteeringFactor__rosidl_typesupport_introspection_c__resize_function__SteeringFactor__cooperation  // resize(index) function pointer
  },
  {
    "type",  // name
    rosidl_typesupport_introspection_c__ROS_TYPE_UINT16,  // type
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, autoware_adapi_v1_msgs, msg, SteeringFactor)() {
  ...
  autoware_adapi_v1_msgs__msg__SteeringFactor__rosidl_typesupport_introspection_c__SteeringFactor_message_member_array[7].members_ =
