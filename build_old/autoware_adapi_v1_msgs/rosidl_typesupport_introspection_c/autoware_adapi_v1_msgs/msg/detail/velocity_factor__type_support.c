...
size_t autoware_adapi_v1_msgs__msg__VelocityFactor__rosidl_typesupport_introspection_c__size_function__VelocityFactor__cooperation(
...
const void * autoware_adapi_v1_msgs__msg__VelocityFactor__rosidl_typesupport_introspection_c__get_const_function__VelocityFactor__cooperation(
...
void * autoware_adapi_v1_msgs__msg__VelocityFactor__rosidl_typesupport_introspection_c__get_function__VelocityFactor__cooperation(
...
void autoware_adapi_v1_msgs__msg__VelocityFactor__rosidl_typesupport_introspection_c__fetch_function__VelocityFactor__cooperation(
  const void * untyped_member, size_t index, void * untyped_value)
{
  const autoware_adapi_v1_msgs__msg__CooperationStatus * item =
    ((const autoware_adapi_v1_msgs__msg__CooperationStatus *)
    autoware_adapi_v1_msgs__msg__VelocityFactor__rosidl_typesupport_introspection_c__get_const_function__VelocityFactor__cooperation(untyped_member, index));
  autoware_adapi_v1_msgs__msg__CooperationStatus * value =
    (autoware_adapi_v1_msgs__msg__CooperationStatus *)(untyped_value);
  *value = *item;
}

void autoware_adapi_v1_msgs__msg__VelocityFactor__rosidl_typesupport_introspection_c__assign_function__VelocityFactor__cooperation(
  void * untyped_member, size_t index, const void * untyped_value)
{
  autoware_adapi_v1_msgs__msg__CooperationStatus * item =
    ((autoware_adapi_v1_msgs__msg__CooperationStatus *)
    autoware_adapi_v1_msgs__msg__VelocityFactor__rosidl_typesupport_introspection_c__get_function__VelocityFactor__cooperation(untyped_member, index));
...
bool autoware_adapi_v1_msgs__msg__VelocityFactor__rosidl_typesupport_introspection_c__resize_function__VelocityFactor__cooperation(
...
static rosidl_typesupport_introspection_c__MessageMember autoware_adapi_v1_msgs__msg__VelocityFactor__rosidl_typesupport_introspection_c__VelocityFactor_message_member_array[8] = {
  {
    "pose",  // name
  ...
  },
  {
    ...
    NULL,  // default value
    autoware_adapi_v1_msgs__msg__VelocityFactor__rosidl_typesupport_introspection_c__size_function__VelocityFactor__cooperation,  // size() function pointer
    autoware_adapi_v1_msgs__msg__VelocityFactor__rosidl_typesupport_introspection_c__get_const_function__VelocityFactor__cooperation,  // get_const(index) function pointer
    autoware_adapi_v1_msgs__msg__VelocityFactor__rosidl_typesupport_introspection_c__get_function__VelocityFactor__cooperation,  // get(index) function pointer
    autoware_adapi_v1_msgs__msg__VelocityFactor__rosidl_typesupport_introspection_c__fetch_function__VelocityFactor__cooperation,  // fetch(index, &value) function pointer
    autoware_adapi_v1_msgs__msg__VelocityFactor__rosidl_typesupport_introspection_c__assign_function__VelocityFactor__cooperation,  // assign(index, value) function pointer
    autoware_adapi_v1_msgs__msg__VelocityFactor__rosidl_typesupport_introspection_c__resize_function__VelocityFactor__cooperation  // resize(index) function pointer
  },
  {
    "type",  // name
    rosidl_typesupport_introspection_c__ROS_TYPE_UINT16,  // type
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, autoware_adapi_v1_msgs, msg, VelocityFactor)() {
  ...
  autoware_adapi_v1_msgs__msg__VelocityFactor__rosidl_typesupport_introspection_c__VelocityFactor_message_member_array[6].members_ =
