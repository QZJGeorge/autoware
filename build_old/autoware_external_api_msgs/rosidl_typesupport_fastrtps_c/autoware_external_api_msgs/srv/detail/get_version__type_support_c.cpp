  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = autoware_external_api_msgs__srv__GetVersion_Request;
    is_plain =
      (
...
static size_t _GetVersion_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_autoware_external_api_msgs__srv__GetVersion_Request(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = autoware_external_api_msgs__srv__GetVersion_Response;
    is_plain =
      (
...
static size_t _GetVersion_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_autoware_external_api_msgs__srv__GetVersion_Response(
    full_bounded, is_plain, 0);
