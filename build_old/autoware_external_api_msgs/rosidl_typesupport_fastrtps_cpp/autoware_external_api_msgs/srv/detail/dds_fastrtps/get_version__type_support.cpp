...
#include "autoware_external_api_msgs/srv/detail/get_version__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = autoware_external_api_msgs::srv::GetVersion_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const autoware_external_api_msgs::srv::GetVersion_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<autoware_external_api_msgs::srv::GetVersion_Request *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _GetVersion_Request__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const autoware_external_api_msgs::srv::GetVersion_Request *>(
...
static size_t _GetVersion_Request__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_GetVersion_Request(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _GetVersion_Request__callbacks = {
...
static rosidl_message_type_support_t _GetVersion_Request__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_GetVersion_Request__callbacks,
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_autoware_external_api_msgs
const rosidl_message_type_support_t *
get_message_type_support_handle<autoware_external_api_msgs::srv::GetVersion_Request>()
{
  return &autoware_external_api_msgs::srv::typesupport_fastrtps_cpp::_GetVersion_Request__handle;
}
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = autoware_external_api_msgs::srv::GetVersion_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const autoware_external_api_msgs::srv::GetVersion_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<autoware_external_api_msgs::srv::GetVersion_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _GetVersion_Response__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const autoware_external_api_msgs::srv::GetVersion_Response *>(
...
static size_t _GetVersion_Response__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_GetVersion_Response(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _GetVersion_Response__callbacks = {
  "autoware_external_api_msgs::srv",
  "GetVersion_Response",
...
static rosidl_message_type_support_t _GetVersion_Response__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_GetVersion_Response__callbacks,
  get_message_typesupport_handle_function,
};
...
{
  return &autoware_external_api_msgs::srv::typesupport_fastrtps_cpp::_GetVersion_Response__handle;
}
...
static service_type_support_callbacks_t _GetVersion__callbacks = {
  "autoware_external_api_msgs::srv",
  "GetVersion",
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, autoware_external_api_msgs, srv, GetVersion_Request)(),
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, autoware_external_api_msgs, srv, GetVersion_Response)(),
...
static rosidl_service_type_support_t _GetVersion__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_GetVersion__callbacks,
...
{
  return &autoware_external_api_msgs::srv::typesupport_fastrtps_cpp::_GetVersion__handle;
}
