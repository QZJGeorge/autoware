...
autoware_planning_msgs__msg__Trajectory__init(autoware_planning_msgs__msg__Trajectory * msg)
{
  ...
  for (size_t i = 0; i < 10000; ++i) {
    if (!autoware_planning_msgs__msg__TrajectoryPoint__init(&msg->points[i])) {
      autoware_planning_msgs__msg__Trajectory__fini(msg);
      return false;
    }
  }
...
autoware_planning_msgs__msg__Trajectory__fini(autoware_planning_msgs__msg__Trajectory * msg)
{
  ...
  // points
  for (size_t i = 0; i < 10000; ++i) {
    autoware_planning_msgs__msg__TrajectoryPoint__fini(&msg->points[i]);
  }
}
  ...
  autoware_planning_msgs__msg__Trajectory__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    autoware_planning_msgs__msg__Trajectory * data =
      (autoware_planning_msgs__msg__Trajectory *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!autoware_planning_msgs__msg__Trajectory__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          autoware_planning_msgs__msg__Trajectory__fini(&output->data[i]);
        }
        return false;
      }
    }
