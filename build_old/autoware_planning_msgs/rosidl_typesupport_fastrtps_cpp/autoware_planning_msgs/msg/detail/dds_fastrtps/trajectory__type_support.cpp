...
#include "autoware_planning_msgs/msg/detail/trajectory__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const autoware_planning_msgs::msg::TrajectoryPoint &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
...
cdr_serialize(
  const autoware_planning_msgs::msg::Trajectory & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  autoware_planning_msgs::msg::Trajectory & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  // Member: points
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        autoware_planning_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_TrajectoryPoint(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = autoware_planning_msgs::msg::Trajectory;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const autoware_planning_msgs::msg::Trajectory *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<autoware_planning_msgs::msg::Trajectory *>(
    untyped_ros_message);
...
{
  return &autoware_planning_msgs::msg::typesupport_fastrtps_cpp::_Trajectory__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, autoware_planning_msgs, msg, Trajectory)() {
  return &autoware_planning_msgs::msg::typesupport_fastrtps_cpp::_Trajectory__handle;
}
