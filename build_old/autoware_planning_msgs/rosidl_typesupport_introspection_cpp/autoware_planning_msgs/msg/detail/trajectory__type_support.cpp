...
{
  new (message_memory) autoware_planning_msgs::msg::Trajectory(_init);
}

void Trajectory_fini_function(void * message_memory)
{
  auto typed_message = static_cast<autoware_planning_msgs::msg::Trajectory *>(message_memory);
...
{
  const auto & member =
    *reinterpret_cast<const std::array<autoware_planning_msgs::msg::TrajectoryPoint, 10000> *>(untyped_member);
  return &member[index];
}
...
{
  auto & member =
    *reinterpret_cast<std::array<autoware_planning_msgs::msg::TrajectoryPoint, 10000> *>(untyped_member);
  return &member[index];
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Trajectory_message_member_array[2] = {
  {
    ...
    offsetof(autoware_planning_msgs::msg::Trajectory, header),  // bytes offset in struct
  ...
  },
  {
    ...
    10000,  // array size
    false,  // is upper bound
    offsetof(autoware_planning_msgs::msg::Trajectory, points),  // bytes offset in struct
    nullptr,  // default value
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Trajectory_message_members = {
  ...
  2,  // number of fields
  sizeof(autoware_planning_msgs::msg::Trajectory),
...
get_message_type_support_handle<autoware_planning_msgs::msg::Trajectory>()
{
  return &::autoware_planning_msgs::msg::rosidl_typesupport_introspection_cpp::Trajectory_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, autoware_planning_msgs, msg, Trajectory)() {
  return &::autoware_planning_msgs::msg::rosidl_typesupport_introspection_cpp::Trajectory_message_type_support_handle;
}
