...
class PathWithLaneId(metaclass=Metaclass_PathWithLaneId):
    ...
    _fields_and_field_types = {
        ...
        'points': 'sequence<autoware_planning_msgs/PathPointWithLaneId>',
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['autoware_planning_msgs', 'msg'], 'PathPointWithLaneId')),  # noqa: E501
