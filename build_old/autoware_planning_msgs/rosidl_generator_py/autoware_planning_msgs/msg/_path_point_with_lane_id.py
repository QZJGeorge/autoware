    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'autoware_planning_msgs.msg.PathPointWithLaneId')
            logger.debug(
...
class PathPointWithLaneId(metaclass=Metaclass_PathPointWithLaneId):
    ...
    _fields_and_field_types = {
        'point': 'autoware_planning_msgs/PathPoint',
        'lane_ids': 'sequence<int64>',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['autoware_planning_msgs', 'msg'], 'PathPoint'),  # noqa: E501
