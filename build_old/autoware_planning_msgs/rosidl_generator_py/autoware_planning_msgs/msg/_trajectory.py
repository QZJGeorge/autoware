...
class Trajectory(metaclass=Metaclass_Trajectory):
    ...
    _fields_and_field_types = {
        ...
        'points': 'autoware_planning_msgs/TrajectoryPoint[10000]',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['std_msgs', 'msg'], 'Header'),  # noqa: E501
        rosidl_parser.definition.Array(rosidl_parser.definition.NamespacedType(['autoware_planning_msgs', 'msg'], 'TrajectoryPoint'), 10000),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        self.points = kwargs.get(
            'points',
            [TrajectoryPoint() for x in range(10000)]
        )
        ...
        if __debug__:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 True), \
                "The 'points' field must be a set or sequence with length 10000 and each value of type 'TrajectoryPoint'"
        self._points = value
