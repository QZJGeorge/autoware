...
#define NODE_MAIN_LOGGER_NAME "object_velocity_splitter_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libobject_velocity_splitter_node_component.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<object_velocity_splitter::ObjectVelocitySplitterNode>";
