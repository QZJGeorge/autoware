...
#ifndef BEHAVIOR_VELOCITY_PLANNER__SRV__DETAIL__LOAD_PLUGIN__FUNCTIONS_H_
#define BEHAVIOR_VELOCITY_PLANNER__SRV__DETAIL__LOAD_PLUGIN__FUNCTIONS_H_
...
/// Initialize srv/LoadPlugin message.
/**
...
/// Finalize srv/LoadPlugin message.
/**
...
/// Create srv/LoadPlugin message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * behavior_velocity_planner__srv__LoadPlugin_Request__init().
...
/// Destroy srv/LoadPlugin message.
/**
 * It calls
 * behavior_velocity_planner__srv__LoadPlugin_Request__fini()
...
/// Check for srv/LoadPlugin message equality.
/**
...
/// Initialize array of srv/LoadPlugin messages.
/**
...
/// Finalize array of srv/LoadPlugin messages.
/**
 * It calls
 * behavior_velocity_planner__srv__LoadPlugin_Request__fini()
...
/// Create array of srv/LoadPlugin messages.
/**
 * It allocates the memory for the array and calls
 * behavior_velocity_planner__srv__LoadPlugin_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/LoadPlugin messages.
/**
 * It calls
 * behavior_velocity_planner__srv__LoadPlugin_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/LoadPlugin message array equality.
/**
...
/// Copy an array of srv/LoadPlugin messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * behavior_velocity_planner__srv__LoadPlugin_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_behavior_velocity_planner
...
/**
 * It calls
 * behavior_velocity_planner__srv__LoadPlugin_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_behavior_velocity_planner
...
/**
 * It allocates the memory for the array and calls
 * behavior_velocity_planner__srv__LoadPlugin_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_behavior_velocity_planner
...
/**
 * It calls
 * behavior_velocity_planner__srv__LoadPlugin_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // BEHAVIOR_VELOCITY_PLANNER__SRV__DETAIL__LOAD_PLUGIN__FUNCTIONS_H_
