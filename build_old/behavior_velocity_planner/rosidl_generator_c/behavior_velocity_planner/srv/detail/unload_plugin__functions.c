...
behavior_velocity_planner__srv__UnloadPlugin_Request__init(behavior_velocity_planner__srv__UnloadPlugin_Request * msg)
{
  ...
  if (!rosidl_runtime_c__String__init(&msg->plugin_name)) {
    behavior_velocity_planner__srv__UnloadPlugin_Request__fini(msg);
    return false;
  }
  return true;
}
...
behavior_velocity_planner__srv__UnloadPlugin_Request__create()
{
  ...
  behavior_velocity_planner__srv__UnloadPlugin_Request * msg = (behavior_velocity_planner__srv__UnloadPlugin_Request *)allocator.allocate(sizeof(behavior_velocity_planner__srv__UnloadPlugin_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(behavior_velocity_planner__srv__UnloadPlugin_Request));
  bool success = behavior_velocity_planner__srv__UnloadPlugin_Request__init(msg);
  if (!success) {
...
behavior_velocity_planner__srv__UnloadPlugin_Request__Sequence__init(behavior_velocity_planner__srv__UnloadPlugin_Request__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  behavior_velocity_planner__srv__UnloadPlugin_Request * data = NULL;

  if (size) {
    data = (behavior_velocity_planner__srv__UnloadPlugin_Request *)allocator.zero_allocate(size, sizeof(behavior_velocity_planner__srv__UnloadPlugin_Request), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = behavior_velocity_planner__srv__UnloadPlugin_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        behavior_velocity_planner__srv__UnloadPlugin_Request__fini(&data[i - 1]);
      }
...
behavior_velocity_planner__srv__UnloadPlugin_Request__Sequence__fini(behavior_velocity_planner__srv__UnloadPlugin_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      behavior_velocity_planner__srv__UnloadPlugin_Request__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  behavior_velocity_planner__srv__UnloadPlugin_Request__Sequence * array = (behavior_velocity_planner__srv__UnloadPlugin_Request__Sequence *)allocator.allocate(sizeof(behavior_velocity_planner__srv__UnloadPlugin_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = behavior_velocity_planner__srv__UnloadPlugin_Request__Sequence__init(array, size);
  if (!success) {
...
behavior_velocity_planner__srv__UnloadPlugin_Request__Sequence__destroy(behavior_velocity_planner__srv__UnloadPlugin_Request__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    behavior_velocity_planner__srv__UnloadPlugin_Request__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
behavior_velocity_planner__srv__UnloadPlugin_Request__Sequence__are_equal(const behavior_velocity_planner__srv__UnloadPlugin_Request__Sequence * lhs, const behavior_velocity_planner__srv__UnloadPlugin_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!behavior_velocity_planner__srv__UnloadPlugin_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  behavior_velocity_planner__srv__UnloadPlugin_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(behavior_velocity_planner__srv__UnloadPlugin_Request);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    behavior_velocity_planner__srv__UnloadPlugin_Request * data =
      (behavior_velocity_planner__srv__UnloadPlugin_Request *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!behavior_velocity_planner__srv__UnloadPlugin_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          behavior_velocity_planner__srv__UnloadPlugin_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!behavior_velocity_planner__srv__UnloadPlugin_Request__copy(
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  behavior_velocity_planner__srv__UnloadPlugin_Response * msg = (behavior_velocity_planner__srv__UnloadPlugin_Response *)allocator.allocate(sizeof(behavior_velocity_planner__srv__UnloadPlugin_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(behavior_velocity_planner__srv__UnloadPlugin_Response));
  bool success = behavior_velocity_planner__srv__UnloadPlugin_Response__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
behavior_velocity_planner__srv__UnloadPlugin_Response__destroy(behavior_velocity_planner__srv__UnloadPlugin_Response * msg)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (msg) {
    behavior_velocity_planner__srv__UnloadPlugin_Response__fini(msg);
  }
  allocator.deallocate(msg, allocator.state);
}
...
behavior_velocity_planner__srv__UnloadPlugin_Response__Sequence__init(behavior_velocity_planner__srv__UnloadPlugin_Response__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  behavior_velocity_planner__srv__UnloadPlugin_Response * data = NULL;

  if (size) {
    data = (behavior_velocity_planner__srv__UnloadPlugin_Response *)allocator.zero_allocate(size, sizeof(behavior_velocity_planner__srv__UnloadPlugin_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = behavior_velocity_planner__srv__UnloadPlugin_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        behavior_velocity_planner__srv__UnloadPlugin_Response__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
behavior_velocity_planner__srv__UnloadPlugin_Response__Sequence__fini(behavior_velocity_planner__srv__UnloadPlugin_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      behavior_velocity_planner__srv__UnloadPlugin_Response__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  behavior_velocity_planner__srv__UnloadPlugin_Response__Sequence * array = (behavior_velocity_planner__srv__UnloadPlugin_Response__Sequence *)allocator.allocate(sizeof(behavior_velocity_planner__srv__UnloadPlugin_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = behavior_velocity_planner__srv__UnloadPlugin_Response__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
behavior_velocity_planner__srv__UnloadPlugin_Response__Sequence__destroy(behavior_velocity_planner__srv__UnloadPlugin_Response__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    behavior_velocity_planner__srv__UnloadPlugin_Response__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
behavior_velocity_planner__srv__UnloadPlugin_Response__Sequence__are_equal(const behavior_velocity_planner__srv__UnloadPlugin_Response__Sequence * lhs, const behavior_velocity_planner__srv__UnloadPlugin_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!behavior_velocity_planner__srv__UnloadPlugin_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  behavior_velocity_planner__srv__UnloadPlugin_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(behavior_velocity_planner__srv__UnloadPlugin_Response);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    behavior_velocity_planner__srv__UnloadPlugin_Response * data =
      (behavior_velocity_planner__srv__UnloadPlugin_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!behavior_velocity_planner__srv__UnloadPlugin_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          behavior_velocity_planner__srv__UnloadPlugin_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!behavior_velocity_planner__srv__UnloadPlugin_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
