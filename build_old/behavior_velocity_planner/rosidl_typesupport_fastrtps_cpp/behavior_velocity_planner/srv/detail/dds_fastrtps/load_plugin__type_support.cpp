...
#include "behavior_velocity_planner/srv/detail/load_plugin__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = behavior_velocity_planner::srv::LoadPlugin_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const behavior_velocity_planner::srv::LoadPlugin_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<behavior_velocity_planner::srv::LoadPlugin_Request *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _LoadPlugin_Request__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const behavior_velocity_planner::srv::LoadPlugin_Request *>(
...
static size_t _LoadPlugin_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_LoadPlugin_Request(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _LoadPlugin_Request__callbacks = {
...
static rosidl_message_type_support_t _LoadPlugin_Request__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_LoadPlugin_Request__callbacks,
...
{
  return &behavior_velocity_planner::srv::typesupport_fastrtps_cpp::_LoadPlugin_Request__handle;
}
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = behavior_velocity_planner::srv::LoadPlugin_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const behavior_velocity_planner::srv::LoadPlugin_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<behavior_velocity_planner::srv::LoadPlugin_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _LoadPlugin_Response__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const behavior_velocity_planner::srv::LoadPlugin_Response *>(
...
static size_t _LoadPlugin_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_LoadPlugin_Response(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _LoadPlugin_Response__callbacks = {
  "behavior_velocity_planner::srv",
  "LoadPlugin_Response",
...
static rosidl_message_type_support_t _LoadPlugin_Response__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_LoadPlugin_Response__callbacks,
  get_message_typesupport_handle_function,
};
...
{
  return &behavior_velocity_planner::srv::typesupport_fastrtps_cpp::_LoadPlugin_Response__handle;
}
...
static service_type_support_callbacks_t _LoadPlugin__callbacks = {
  "behavior_velocity_planner::srv",
  "LoadPlugin",
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, behavior_velocity_planner, srv, LoadPlugin_Request)(),
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, behavior_velocity_planner, srv, LoadPlugin_Response)(),
...
static rosidl_service_type_support_t _LoadPlugin__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_LoadPlugin__callbacks,
...
{
  return &behavior_velocity_planner::srv::typesupport_fastrtps_cpp::_LoadPlugin__handle;
}
