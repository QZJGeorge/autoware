...
#define NODE_MAIN_LOGGER_NAME "behavior_velocity_planner_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libbehavior_velocity_planner_lib.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<behavior_velocity_planner::BehaviorVelocityPlannerNode>";
