...
#include "behavior_velocity_planner/srv/detail/unload_plugin__rosidl_typesupport_fastrtps_c.h"
...
using _UnloadPlugin_Request__ros_msg_type = behavior_velocity_planner__srv__UnloadPlugin_Request;
...
size_t get_serialized_size_behavior_velocity_planner__srv__UnloadPlugin_Request(
  const void * untyped_ros_message,
...
static uint32_t _UnloadPlugin_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_behavior_velocity_planner__srv__UnloadPlugin_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_behavior_velocity_planner
size_t max_serialized_size_behavior_velocity_planner__srv__UnloadPlugin_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = behavior_velocity_planner__srv__UnloadPlugin_Request;
    is_plain =
      (
...
static size_t _UnloadPlugin_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_behavior_velocity_planner__srv__UnloadPlugin_Request(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, behavior_velocity_planner, srv, UnloadPlugin_Request)() {
...
using _UnloadPlugin_Response__ros_msg_type = behavior_velocity_planner__srv__UnloadPlugin_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_behavior_velocity_planner
size_t get_serialized_size_behavior_velocity_planner__srv__UnloadPlugin_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _UnloadPlugin_Response__ros_msg_type * ros_message = static_cast<const _UnloadPlugin_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_behavior_velocity_planner__srv__UnloadPlugin_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_behavior_velocity_planner
size_t max_serialized_size_behavior_velocity_planner__srv__UnloadPlugin_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = behavior_velocity_planner__srv__UnloadPlugin_Response;
    is_plain =
      (
...
static size_t _UnloadPlugin_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_behavior_velocity_planner__srv__UnloadPlugin_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, behavior_velocity_planner, srv, UnloadPlugin_Response)() {
...
// already included above
// #include "behavior_velocity_planner/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "behavior_velocity_planner/srv/unload_plugin.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, behavior_velocity_planner, srv, UnloadPlugin)() {
