...
#include "tier4_api_msgs/msg/detail/door_status__rosidl_typesupport_fastrtps_c.h"
...
using _DoorStatus__ros_msg_type = tier4_api_msgs__msg__DoorStatus;
...
size_t get_serialized_size_tier4_api_msgs__msg__DoorStatus(
  const void * untyped_ros_message,
...
static uint32_t _DoorStatus__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_tier4_api_msgs__msg__DoorStatus(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_tier4_api_msgs
size_t max_serialized_size_tier4_api_msgs__msg__DoorStatus(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = tier4_api_msgs__msg__DoorStatus;
    is_plain =
      (
...
static size_t _DoorStatus__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_tier4_api_msgs__msg__DoorStatus(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, tier4_api_msgs, msg, DoorStatus)() {
