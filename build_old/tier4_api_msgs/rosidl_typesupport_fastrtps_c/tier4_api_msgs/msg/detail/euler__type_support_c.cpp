...
#include "tier4_api_msgs/msg/detail/euler__rosidl_typesupport_fastrtps_c.h"
...
using _Euler__ros_msg_type = tier4_api_msgs__msg__Euler;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _Euler__ros_msg_type * ros_message = static_cast<const _Euler__ros_msg_type *>(untyped_ros_message);
  // Field name: roll
  {
  ...
  void * untyped_ros_message)
{
  ...
  _Euler__ros_msg_type * ros_message = static_cast<_Euler__ros_msg_type *>(untyped_ros_message);
  // Field name: roll
  {
    cdr >> ros_message->roll;
  }
...
static uint32_t _Euler__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_tier4_api_msgs__msg__Euler(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = tier4_api_msgs__msg__Euler;
    is_plain =
      (
...
static size_t _Euler__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_tier4_api_msgs__msg__Euler(
...
static message_type_support_callbacks_t __callbacks_Euler = {
  "tier4_api_msgs::msg",
  "Euler",
...
static rosidl_message_type_support_t _Euler__type_support = {
