...
#include "tier4_api_msgs/msg/detail/velocity_limit__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const tier4_api_msgs::msg::VelocityLimit & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  tier4_api_msgs::msg::VelocityLimit & ros_message)
{
  // Member: stamp
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = tier4_api_msgs::msg::VelocityLimit;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const tier4_api_msgs::msg::VelocityLimit *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<tier4_api_msgs::msg::VelocityLimit *>(
    untyped_ros_message);
...
static size_t _VelocityLimit__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_VelocityLimit(full_bounded, is_plain, 0);
...
{
  return &tier4_api_msgs::msg::typesupport_fastrtps_cpp::_VelocityLimit__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, tier4_api_msgs, msg, VelocityLimit)() {
  return &tier4_api_msgs::msg::typesupport_fastrtps_cpp::_VelocityLimit__handle;
}
