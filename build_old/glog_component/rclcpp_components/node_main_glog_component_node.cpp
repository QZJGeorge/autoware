...
#define NODE_MAIN_LOGGER_NAME "glog_component_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libglog_component.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<GlogComponent>";
