...
#define NODE_MAIN_LOGGER_NAME "concatenate_pointclouds_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<pointcloud_preprocessor::PointCloudConcatenationComponent>";
