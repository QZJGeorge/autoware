...
#define NODE_MAIN_LOGGER_NAME "traffic_light_occlusion_predictor_node"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libtraffic_light_occlusion_predictor.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<traffic_light::TrafficLightOcclusionPredictorNodelet>";
